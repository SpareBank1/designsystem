export const SIMPLE_TABLE = {
  ...
  // Med datakey kan man "velge" ut hvilke data man ønsker å vise fra dataObject
  tableColumns: [
    { dataKey: 'name', content: 'Navn' },
    { dataKey: 'address', content: 'Adresse' },
    { dataKey: 'phone', content: 'Telefon' },
    { dataKey: 'email', content: 'E-post' },
  ],
  dataObject: [
    {
      name: 'Ola Normann',
