    ...
    return (
        <div>
            <RadioButtonInputGroup
                ...
                onChange={e =>
                    setColorScheme(e.target.value as ColorSchemeType)
                }
            >
                {innerProps => (
                    <>
                        <RadioButton {...innerProps} value="light">
                            Lys
                        </RadioButton>
                        <RadioButton {...innerProps} value="dark">
                            Mørk
                        </RadioButton>
                        <RadioButton {...innerProps} value="automatisk">
                            Automatisk
                        </RadioButton>
                    </>
                )}
    ...
    return (
        <>
            {systemMessageVisible && (
                <SystemMessage type="info" className="mb-4">
                    Du har trigget en systemmelding! Her kan det stå hva som
                    helst
                </SystemMessage>
            )}
            ...
            <div>
                ...
                {activeTab === 'security' && (
                    <div>
                        ...
                        <SafetyView
                            onTriggerContextMessage={() =>
                                setSystemMessageVisible(!systemMessageVisible)
                            }
                        />
                    </div>
                )}
