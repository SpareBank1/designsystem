import{j as e,M as i}from"./index-DgDxNa5X.js";import{useMDXComponents as t}from"./index-DmqVK_gK.js";import"./iframe-DxewrjMp.js";import"./index-DQDNmYQF.js";import"./index-CGBZXJ9a.js";import"./index-DrriUsT5.js";import"./index-CXQShRbs.js";import"./index-DrFu-skq.js";function s(r){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",ul:"ul",...t(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Introduksjon/Changelog"}),`
...
`,e.jsxs(n.p,{children:["For de som bruker Tailwind kan en oppdatere importen fra ",e.jsx(n.code,{children:"@sb1/ffe-core/lib/colors"})," til ",e.jsx(n.code,{children:"@sb1/ffe-core/lib/semanticColorsTailwind"}),"."]}),`
...
`})}),`
`,e.jsxs(n.p,{children:["Da blir fargene tilgjengelige i kebab-case uten ",e.jsx(n.code,{children:"--ffe-color"}),". Feks ",e.jsx(n.code,{children:"--ffe-color-background-default"})," -> ",e.jsx(n.code,{children:"background-default"})]})]})}function h(r={}){const{wrapper:n}={...t(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(s,{...r})}):s(r)}export{h as default};
