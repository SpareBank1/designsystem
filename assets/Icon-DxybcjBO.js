import{j as e,M as t,C as i,a as d}from"./index-9VqfWku3.js";import{useMDXComponents as l}from"./index-DmqVK_gK.js";import{I as a,S as s,a as c,W as k,U as m}from"./Icon.stories-Bke1-D01.js";import{I as p}from"./InstallImport-DG_JUqwD.js";import"./iframe-BNgHGsQC.js";import"./index-DQDNmYQF.js";import"./index-CGBZXJ9a.js";import"./index-DrriUsT5.js";import"./index-CXQShRbs.js";import"./index-DrFu-skq.js";import"./index-QCImZZ3W.js";import"./Heading-D_Y6r1eI.js";import"./Paragraph-DEYlXMQQ.js";const h=""+new URL("bytte-ikon-0--Bbvjd.png",import.meta.url).href,g=""+new URL("velger-tekststil-Cnzr0Gvc.png",import.meta.url).href,f=["@sb1/ffe-icons"];function o(r){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",...l(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{of:a}),`
...
`,e.jsx(p,{packageName:"@sb1/ffe-icons-react",dependencies:f}),`
...
`,e.jsxs(n.p,{children:[`Hvis ikonet ikke vises, men i stedet blir en firkantet boks etter deploy, kan det skyldes at SVG-filen ikke blir
riktig håndtert av byggeverktøyet. Prøv å legge til `,e.jsx(n.code,{children:"build.assetsInlineLimit: 0"})," i ",e.jsx(n.code,{children:"vite.config.ts"}),`
...
`,e.jsx(i,{of:m})]})}function w(r={}){const{wrapper:n}={...l(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(o,{...r})}):o(r)}export{w as default};
