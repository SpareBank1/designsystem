import{R as e}from"./index-eCxJ45ll.js";import{c as g}from"./index-DezCrw0f.js";import{f as C,W as E}from"./WithCardAction-D8xJ0iKc.js";import{C as G,T as b,S as R,a as N}from"./Title-Q79Fy4wU.js";import{H as c}from"./Heading-Bi1Q8xC8.js";import{P as T}from"./Paragraph-Qjq98ToE.js";function q({className:n,children:r,bgColor:o="primary",noMargin:l,...a},t){return e.createElement("div",{className:g("ffe-group-card",{"ffe-group-card--no-margin":l,[`ffe-group-card--bg-${o}`]:o},n),role:"group",...a,ref:t},r)}const u=C(q);u.__docgenInfo={description:"",methods:[],displayName:"GroupCard",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"The children of the GroupCard component"},bgColor:{required:!1,tsType:{name:"union",raw:"'primary' | 'secondary' | 'tertiary'",elements:[{name:"literal",value:"'primary'"},{name:"literal",value:"'secondary'"},{name:"literal",value:"'tertiary'"}]},description:"The background color of the whole groupcard element\n\nProperty has new values that work with dark and accent mode as part of the Semantic Color update\nPossible values: `primary` `secondary` `tertiary`\n[Read more in the upgrade guide](https://sparebank1.github.io/designsystem/?path=/docs/introduksjon-changelog--docs#2025---februar---semantiske-farger)",defaultValue:{value:"'primary'",computed:!1}},bgDarkmodeColor:{required:!1,tsType:{name:"never"},description:`@deprecated as part of update to Semantic Colors
