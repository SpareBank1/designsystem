import{R as e}from"./index-eCxJ45ll.js";import{c as f}from"./index-DezCrw0f.js";import{f as E,W as k}from"./WithCardAction-D8xJ0iKc.js";import{C as R,T as b,S as T,a as N}from"./Title-Q79Fy4wU.js";import{H as g}from"./Heading-D-TqytO6.js";import{P as _}from"./Paragraph-Qjq98ToE.js";function L({shadow:n,className:r,children:d,bgColor:l,bgDarkmodeColor:o,noMargin:a,...p},m){return e.createElement("div",{className:f("ffe-group-card",{"ffe-group-card--shadow":n,"ffe-group-card--no-margin":a,[`ffe-group-card--bg-${l}`]:l,[`ffe-group-card--dm-bg-${o}`]:o},r),role:"group",...p,ref:m},d)}const i=E(L);i.__docgenInfo={description:"",methods:[],displayName:"GroupCard",props:{shadow:{required:!1,tsType:{name:"boolean"},description:""},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"The children of the GroupCard component"},bgColor:{required:!1,tsType:{name:"union",raw:`| 'sand-30'
| 'sand-70'
| 'frost-30'
| 'syrin-30'
| 'syrin-70'`,elements:[{name:"literal",value:"'sand-30'"},{name:"literal",value:"'sand-70'"},{name:"literal",value:"'frost-30'"},{name:"literal",value:"'syrin-30'"},{name:"literal",value:"'syrin-70'"}]},description:"The background color of the whole groupcard element"},bgDarkmodeColor:{required:!1,tsType:{name:"union",raw:"'natt' | 'svart' | 'koksgraa'",elements:[{name:"literal",value:"'natt'"},{name:"literal",value:"'svart'"},{name:"literal",value:"'koksgraa'"}]},description:"The background color for darkmode of the whole groupcard element"},noMargin:{required:!1,tsType:{name:"boolean"},description:"No margin on card"}},composes:["Omit"]};function W(n,r){const{className:d,noPadding:l=!1,noSeparator:o=!1,children:a,...p}=n;return e.createElement(k,{baseClassName:"ffe-group-card__title",className:f("ffe-group-card__title",d,{"ffe-group-card__element--no-padding":l,"ffe-group-card__element--no-separator":o}),...p,ref:r},({CardAction:m})=>typeof a=="function"?a({Text:N,Subtext:T,Title:b,CardName:R,CardAction:m}):a)}const G=E(W);G.__docgenInfo={description:"",methods:[],displayName:"GroupCardTitle",props:{noPadding:{required:!1,tsType:{name:"boolean"},description:"No padding on the element"},noSeparator:{required:!1,tsType:{name:"boolean"},description:"Visible border underneath title"},children:{required:!0,tsType:{name:"union",raw:`| React.ReactNode
...
| ((cardRenderProps: CardRenderProps) => React.ReactNode)`,elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"unknown"}]},description:""}}};function V(n,r){const{className:d,noPadding:l=!1,children:o,...a}=n;return e.createElement(k,{baseClassName:"ffe-group-card__footer",className:f("ffe-group-card__footer",d,{"ffe-group-card__element--no-padding":l}),...a,ref:r},({CardAction:p})=>typeof o=="function"?o({Text:N,Subtext:T,Title:b,CardName:R,CardAction:p}):o)}const h=E(V);h.__docgenInfo={description:"",methods:[],displayName:"GroupCardFooter",props:{noPadding:{required:!1,tsType:{name:"boolean"},description:"No padding on the element"},children:{required:!0,tsType:{name:"union",raw:`| React.ReactNode
