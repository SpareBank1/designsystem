import{R as e}from"./index-DQDNmYQF.js";import{c as C}from"./index-D2FocPV0.js";import{f as S,W as E}from"./WithCardAction-BvL5dv80.js";import{C as k,T as q,S as N,a as h}from"./Title-Rg7Vduii.js";function w(a,t){const{className:n,imageSrc:r,imageAltText:i,noMargin:d,appearance:b="default",children:l,...x}=a;return e.createElement(E,{baseClassName:"ffe-image-card",className:C("ffe-image-card",{"ffe-image-card--no-margin":d,"ffe-default-mode":b==="default"},n),...x,ref:t},({CardAction:v})=>e.createElement(e.Fragment,null,e.createElement("div",{className:"ffe-image-card__image-container"},e.createElement("div",{className:"ffe-image-card__image-overlay"}),e.createElement("img",{src:r,alt:i,className:"ffe-image-card__image"})),e.createElement("div",{className:"ffe-image-card__body"},typeof l=="function"?l({Text:h,Subtext:N,Title:q,CardName:k,CardAction:v}):l)))}const s=S(w);s.__docgenInfo={description:"",methods:[],displayName:"ImageCard",props:{imageSrc:{required:!0,tsType:{name:"string"},description:"The src for the image"},imageAltText:{required:!0,tsType:{name:"string"},description:"The alt text for the image"},noMargin:{required:!1,tsType:{name:"boolean"},description:"No margin on card"},appearance:{required:!1,tsType:{name:"union",raw:"'default' | 'accent'",elements:[{name:"literal",value:"'default'"},{name:"literal",value:"'accent'"}]},description:"Avgjør utseende i kontekst accent. Hvis man ønsker et blått utseende i kontekst accent, velg appearance: 'accent'"},children:{required:!0,tsType:{name:"union",raw:`| React.ReactNode
