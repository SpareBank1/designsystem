import{R as e}from"./index-DQDNmYQF.js";import{c as g}from"./index-QCImZZ3W.js";import{f as x,W as T}from"./WithCardAction-BEfhMYaK.js";import{C as b,T as C,S as v,a as N}from"./Title-CmDdbz_O.js";function R(t,r){const{className:n,leftAlign:o,noMargin:s,appearance:u="default",children:i,...p}=t;return e.createElement(T,{baseClassName:"ffe-text-card",className:g("ffe-text-card",{"ffe-text-card--left-align":o,"ffe-text-card--no-margin":s,"ffe-default-mode":u==="default"},n),...p,ref:r},({CardAction:f})=>typeof i=="function"?i({Text:N,Subtext:v,Title:C,CardName:b,CardAction:f}):i)}const d=x(R);d.__docgenInfo={description:"",methods:[],displayName:"TextCard",props:{leftAlign:{required:!1,tsType:{name:"boolean"},description:"Left-aligned text on the card"},noMargin:{required:!1,tsType:{name:"boolean"},description:"No margin on card"},appearance:{required:!1,tsType:{name:"union",raw:"'default' | 'accent'",elements:[{name:"literal",value:"'default'"},{name:"literal",value:"'accent'"}]},description:"Avgjør utseende i kontekst accent. Hvis man ønsker et blått utseende i kontekst accent, velg appearance: 'accent'"},children:{required:!0,tsType:{name:"union",raw:`| React.ReactNode
