import{R as e,r as T}from"./index-DQDNmYQF.js";import{T as h}from"./Tooltip-B8J4kvmt.js";import{L as I}from"./Label-B7lv4noR.js";import{c as N}from"./index-QCImZZ3W.js";import{E as g}from"./ErrorFieldMessage-eNbkZ9Td.js";const q=(o,a,c)=>typeof o=="function"?o({...a,...c}):e.isValidElement(o)?e.cloneElement(o,a):o,x=({inputId:o,children:a,className:c,extraMargin:f=!0,description:s,label:i,fieldMessage:n,tooltip:t,onTooltipToggle:p,labelId:u,...y})=>{const[b,k]=e.useState(!1),R=T.useId(),r=o??R,l=s?`${r}-description`:void 0;if(e.Children.count(a)>1)throw new Error("This element does not support more than one child. If you need more than one element inside your InputGroup, please use the function-as-a-child pattern outlined in the documentation.");const d=(()=>{var m;return typeof n=="string"?`${r}-fieldmessage`:(m=n==null?void 0:n.props)!=null&&m.id?n.props.id:n?`${r}-fieldmessage`:void 0})();if(p&&typeof t!="boolean"&&typeof t!="string")throw new Error(`Only use the "onTooltipToggle" prop if you're not sending a component of type <Tooltip /> in the "tooltip" prop. If you are, use "onClick" on that component instead`);if(t&&s)throw new Error(`Don't use both "tooltip" and "description" on an <InputGroup />, pick one of them`);const v=!!n&&(typeof n=="string"||n.type===g),w=!!n,C=d||l?[d,l].filter(Boolean).join(" "):void 0,E=q(a,{id:r,"aria-invalid":v?"true":"false","aria-describedby":C},{setInputGroupLabelAsSpan:()=>{k(!0)}});return e.createElement("div",{className:N("ffe-input-group",{"ffe-input-group--no-extra-margin":!f,"ffe-input-group--message":w},c),...y},typeof i=="string"?e.createElement(I,{as:b?"span":"label",htmlFor:r,id:u},i):e.isValidElement(i)&&e.cloneElement(i,{htmlFor:r,id:u}),typeof t=="string"&&e.createElement(h,{onClick:p},t),t===!0&&e.createElement(h,{onClick:p}),e.isValidElement(t)&&t,s&&e.createElement("div",{className:"ffe-small-text ffe-input-group__description",id:l},s),E,typeof n=="string"&&e.createElement(g,{as:"p",id:d},n),e.isValidElement(n)&&e.cloneElement(n,{id:d}))};x.__docgenInfo={description:"",methods:[],displayName:"InputGroup",props:{inputId:{required:!1,tsType:{name:"string"},description:"The id that will be used on the input child if you don't want a generated one"},labelId:{required:!1,tsType:{name:"string"},description:"The id used on the label in this component. Could be necessary if your component needs a aria-labelledby."},children:{required:!0,tsType:{name:"union",raw:`| NonNullable<React.ReactNode>
...
Use the \`ffe-accent-color\` class on the component or on the container of the component instead
[Read more in the upgrade guide](https://sparebank1.github.io/designsystem/?path=/docs/introduksjon-changelog--docs#2025---februar---semantiske-farger)`}},composes:["Omit"]};export{x as I};
