import{r as M,R as e}from"./index-eCxJ45ll.js";import{c as b}from"./index-DezCrw0f.js";import{T as L}from"./Tooltip-Cv2kw5GT.js";import{E as _}from"./ErrorFieldMessage-CFe1xxra.js";import{R as o}from"./RadioButton-BJ8GVrSP.js";import{R as x}from"./RadioSwitch-DiErzkz2.js";import{R as h}from"./RadioBlock-DORWPHzR.js";const l=({children:s,className:a,extraMargin:t=!0,description:m,fieldMessage:i,inline:G,label:f,name:C,selectedValue:P,tooltip:u,onChange:g,onColoredBg:r,...H})=>{if(u&&m)throw new Error(`Don't use both "tooltip" and "description" on an <RadioButtonInputGroup />, pick one of them`);const R=M.useId();return e.createElement("fieldset",{"aria-labelledby":R,className:b("ffe-input-group",{"ffe-input-group--on-colored-bg":r},{"ffe-input-group--no-extra-margin":!t},{"ffe-input-group--message":!!i},a),...H},f&&e.createElement("div",{id:R,className:b("ffe-form-label","ffe-form-label--block",{"ffe-form-label--on-colored-bg":r})},f,typeof u=="string"&&e.createElement(L,{onColoredBg:r},u),e.isValidElement(u)&&u),m&&e.createElement("div",{className:"ffe-input-group__description ffe-small-text"},m),s({inline:G,name:C,onChange:F=>{g==null||g(F)},selectedValue:P,onColoredBg:r}),typeof i=="string"?e.createElement(_,{as:"p",onColoredBg:r},i):e.isValidElement(i)&&e.cloneElement(i,{onColoredBg:r}))};l.__docgenInfo={description:"",methods:[],displayName:"RadioButtonInputGroup",props:{children:{required:!0,tsType:{name:"signature",type:"function",raw:`(inputProps: {
    inline?: boolean;
    name: string;
...
set`},onColoredBg:{required:!1,tsType:{name:"boolean"},description:"Adds alternative styling for better contrast on certain backgrounds"}},composes:["Omit"]};const j={title:"Komponenter/Form/RadioButtonInputGroup",component:l},n={args:{inline:!1,onColoredBg:!1,name:"favorittlukt",label:"Hva er din favorittlukt?"},render:function(a){return e.createElement(l,{...a},t=>e.createElement(e.Fragment,null,e.createElement(o,{...t,value:"grass"},"Gress"),e.createElement(o,{...t,value:"asphalt"},"Asfalt"),e.createElement(o,{...t,value:"pollen"},"Pollen")))}},d={args:{...n.args,fieldMessage:"Feil lukt",name:"feil-lukt"},render:function(a){return e.createElement(l,{...a},t=>e.createElement(e.Fragment,null,e.createElement(o,{...t,value:"grass"},"Gress"),e.createElement(o,{...t,value:"asphalt"},"Asfalt"),e.createElement(o,{...t,value:"pollen"},"Pollen")))}},c={args:{...n.args,name:"radio-switch"},render:function(a){return e.createElement(l,{...a},t=>e.createElement(x,{leftLabel:"Ja",leftValue:!0,rightLabel:"Nei",rightValue:!1,...t}))}},p={args:{...n.args,selectedValue:"yes",name:"radio-block"},render:function(a){return e.createElement(l,{...a},t=>e.createElement(e.Fragment,null,e.createElement(h,{...t,label:"Ja",value:"yes",selectedValue:a.selectedValue}),e.createElement(h,{...t,selectedValue:a.selectedValue,label:"Nei",showChildren:!0,value:"no"},"Vil ikke!")))}};var v,E,y;n.parameters={...n.parameters,docs:{...(v=n.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    inline: false,
    onColoredBg: false,
    name: 'favorittlukt',
...
}`,...(y=(E=n.parameters)==null?void 0:E.docs)==null?void 0:y.source}}};var B,w,k;d.parameters={...d.parameters,docs:{...(B=d.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
    ...Standard.args,
...
}`,...(k=(w=d.parameters)==null?void 0:w.docs)==null?void 0:k.source}}};var T,V,I;c.parameters={...c.parameters,docs:{...(T=c.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
    ...Standard.args,
    name: 'radio-switch'
  },
