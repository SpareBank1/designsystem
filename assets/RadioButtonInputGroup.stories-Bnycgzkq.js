import{r as F,R as e}from"./index-DJO9vBfz.js";import{c as b}from"./index-i5X67GZP.js";import{T as L}from"./Tooltip-r2BmskYH.js";import{E as _}from"./ErrorFieldMessage-9UPyOtg6.js";import{R as o}from"./RadioButton-CtnZcLk5.js";import{R as x}from"./RadioSwitch-BDTvItGa.js";import{R as h}from"./RadioBlock-DWJoihBo.js";const s=({children:l,className:a,extraMargin:t=!0,description:m,fieldMessage:i,inline:G,label:f,name:C,selectedValue:P,tooltip:u,onChange:g,onColoredBg:r,...H})=>{if(u&&m)throw new Error(`Don't use both "tooltip" and "description" on an <RadioButtonInputGroup />, pick one of them`);const R=F.useId();return e.createElement("fieldset",{"aria-labelledby":R,className:b("ffe-input-group",{"ffe-input-group--on-colored-bg":r},{"ffe-input-group--no-extra-margin":!t},{"ffe-input-group--message":!!i},a),...H},f&&e.createElement("div",{id:R,className:b("ffe-form-label","ffe-form-label--block",{"ffe-form-label--on-colored-bg":r})},f,typeof u=="string"&&e.createElement(L,{onColoredBg:r},u),e.isValidElement(u)&&u),m&&e.createElement("div",{className:"ffe-input-group__description ffe-small-text"},m),l({inline:G,name:C,onChange:M=>{g==null||g(M)},selectedValue:P,onColoredBg:r}),typeof i=="string"?e.createElement(_,{as:"p",onColoredBg:r},i):e.isValidElement(i)&&e.cloneElement(i,{onColoredBg:r}))};s.__docgenInfo={description:"",methods:[],displayName:"RadioButtonInputGroup",props:{children:{required:!0,tsType:{name:"signature",type:"function",raw:`(inputProps: {
    inline?: boolean;
    name: string;
...
set`},onColoredBg:{required:!1,tsType:{name:"boolean"},description:"Adds alternative styling for better contrast on certain backgrounds"}},composes:["Omit"]};const j={title:"components/form/RadioButtonInputGroup",component:s},n={args:{inline:!1,onColoredBg:!1,name:"name",label:"Hva er din favorittlukt?"},render:function(a){return e.createElement(s,{...a},t=>e.createElement(e.Fragment,null,e.createElement(o,{...t,value:"grass"},"Gress"),e.createElement(o,{...t,value:"asphalt"},"Asfalt"),e.createElement(o,{...t,value:"pollen"},"Pollen")))}},d={args:{...n.args,fieldMessage:"Feil lukt"},render:function(a){return e.createElement(s,{...a},t=>e.createElement(e.Fragment,null,e.createElement(o,{...t,value:"grass"},"Gress"),e.createElement(o,{...t,value:"asphalt"},"Asfalt"),e.createElement(o,{...t,value:"pollen"},"Pollen")))}},c={args:{...n.args},render:function(a){return e.createElement(s,{...a},t=>e.createElement(x,{leftLabel:"Ja",leftValue:!0,rightLabel:"Nei",rightValue:!1,...t}))}},p={args:{...n.args,selectedValue:"yes"},render:function(a){return e.createElement(s,{...a},t=>e.createElement(e.Fragment,null,e.createElement(h,{...t,label:"Ja",value:"yes",selectedValue:a.selectedValue}),e.createElement(h,{...t,selectedValue:a.selectedValue,label:"Nei",showChildren:!0,value:"no"},"Vil ikke!")))}};var v,E,y;n.parameters={...n.parameters,docs:{...(v=n.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    inline: false,
    onColoredBg: false,
    name: 'name',
...
}`,...(S=(q=p.parameters)==null?void 0:q.docs)==null?void 0:S.source}}};const A=["Standard","FieldMessage","WithRadioSwitch","WithRadioBlock"],K=Object.freeze(Object.defineProperty({__proto__:null,FieldMessage:d,Standard:n,WithRadioBlock:p,WithRadioSwitch:c,__namedExportsOrder:A,default:j},Symbol.toStringTag,{value:"Module"}));export{d as F,K as R,n as S,c as W,p as a};
