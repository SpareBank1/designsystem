import{R as e,r as T}from"./index-eCxJ45ll.js";import{T as m}from"./Tooltip-CPJirHS1.js";import{L as I}from"./Label-DE4emBle.js";import{c as N}from"./index-DezCrw0f.js";import{E as h}from"./ErrorFieldMessage-BZeYW4Z5.js";const q=(o,a)=>typeof o=="function"?o(a):e.isValidElement(o)?e.cloneElement(o,a):o,j=({inputId:o,children:a,className:g,extraMargin:f=!0,description:s,label:i,fieldMessage:n,tooltip:t,onTooltipToggle:c,labelId:l,...y})=>{const[b,k]=e.useState(!1),R=T.useId(),r=o??R,p=s?`${r}-description`:void 0;if(e.Children.count(a)>1)throw new Error("This element does not support more than one child. If you need more than one element inside your InputGroup, please use the function-as-a-child pattern outlined in the documentation.");const d=(()=>{var u;return typeof n=="string"?`${r}-fieldmessage`:(u=n==null?void 0:n.props)!=null&&u.id?n.props.id:n?`${r}-fieldmessage`:void 0})();if(c&&typeof t!="boolean"&&typeof t!="string")throw new Error(`Only use the "onTooltipToggle" prop if you're not sending a component of type <Tooltip /> in the "tooltip" prop. If you are, use "onClick" on that component instead`);if(t&&s)throw new Error(`Don't use both "tooltip" and "description" on an <InputGroup />, pick one of them`);const v=!!n&&(typeof n=="string"||n.type===h),w=!!n,C=d||p?[d,p].filter(Boolean).join(" "):void 0,E=q(a,{id:r,"aria-invalid":v?"true":"false","aria-describedby":C,setInputGroupLabelAsSpan:()=>k(!0)});return e.createElement("div",{className:N("ffe-input-group",{"ffe-input-group--no-extra-margin":!f,"ffe-input-group--message":w},g),...y},typeof i=="string"?e.createElement(I,{as:b?"span":"label",htmlFor:r,id:l},i):e.isValidElement(i)&&e.cloneElement(i,{htmlFor:r,id:l}),typeof t=="string"&&e.createElement(m,{onClick:c},t),t===!0&&e.createElement(m,{onClick:c}),e.isValidElement(t)&&t,s&&e.createElement("div",{className:"ffe-small-text ffe-input-group__description",id:p},s),E,typeof n=="string"&&e.createElement(h,{as:"p",id:d},n),e.isValidElement(n)&&e.cloneElement(n,{id:d}))};j.__docgenInfo={description:"",methods:[],displayName:"InputGroup",props:{inputId:{required:!1,tsType:{name:"string"},description:"The id that will be used on the input child if you don't want a generated one"},labelId:{required:!1,tsType:{name:"string"},description:"The id used on the label in this component. Could be necessary if your component needs a aria-labelledby."},children:{required:!0,tsType:{name:"union",raw:`| NonNullable<React.ReactNode>
...
Use the \`ffe-accent-color\` class on the component or on the container of the component instead
[Read more in the upgrade guide](https://sparebank1.github.io/designsystem/?path=/docs/introduksjon-changelog--docs#2025---februar---semantiske-farger)`}},composes:["Omit"]};export{j as I};
