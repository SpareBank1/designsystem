import{R as e}from"./index-DQDNmYQF.js";import{c as k}from"./index-QCImZZ3W.js";import{f,W as G}from"./WithCardAction-BEfhMYaK.js";import{C as b,T as R,S as N,a as T}from"./Title-CmDdbz_O.js";import{H as g}from"./Heading-DKfn0IwC.js";import{P as y}from"./Paragraph-DEYlXMQQ.js";function K(t,r){const{className:a,children:n,bgColor:d="primary",noMargin:l,as:s="div",...m}=t;return e.createElement(s,{className:k("ffe-group-card",{"ffe-group-card--no-margin":l,[`ffe-group-card--bg-${d}`]:d},a),role:s==="div"?"group":void 0,...m,ref:r},n)}const p=f(K);p.__docgenInfo={description:"",methods:[],displayName:"GroupCard",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"The children of the GroupCard component"},bgColor:{required:!1,tsType:{name:"union",raw:"'primary' | 'secondary' | 'tertiary'",elements:[{name:"literal",value:"'primary'"},{name:"literal",value:"'secondary'"},{name:"literal",value:"'tertiary'"}]},description:"The background color of the whole groupcard element\n\nProperty has new values that work with dark and accent mode as part of the Semantic Color update\nPossible values: `primary` `secondary` `tertiary`\n[Read more in the upgrade guide](https://sparebank1.github.io/designsystem/?path=/docs/introduksjon-changelog--docs#2025---februar---semantiske-farger)"},bgDarkmodeColor:{required:!1,tsType:{name:"never"},description:`@deprecated as part of update to Semantic Colors
