import{R as e}from"./index-eCxJ45ll.js";import{c as f}from"./index-DezCrw0f.js";import{f as E,W as k}from"./WithCardAction-D8xJ0iKc.js";import{T as R,S as b,a as T,C as N}from"./Title-CCAmy5ta.js";import{H as g}from"./Heading-BC_GpFGN.js";import{P as _}from"./Paragraph-Qjq98ToE.js";function L({shadow:n,className:r,children:d,bgColor:l,bgDarkmodeColor:o,noMargin:a,...p},m){return e.createElement("div",{className:f("ffe-group-card",{"ffe-group-card--shadow":n,"ffe-group-card--no-margin":a,[`ffe-group-card--bg-${l}`]:l,[`ffe-group-card--dm-bg-${o}`]:o},r),role:"group",...p,ref:m},d)}const i=E(L);i.__docgenInfo={description:"",methods:[],displayName:"GroupCard",props:{shadow:{required:!1,tsType:{name:"boolean"},description:""},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"The children of the GroupCard component"},bgColor:{required:!1,tsType:{name:"union",raw:`| 'sand-30'
| 'sand-70'
| 'frost-30'
| 'syrin-30'
