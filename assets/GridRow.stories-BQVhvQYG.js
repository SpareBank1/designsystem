import{R as r}from"./index-ne9I_3bB.js";import{a as s,G as l,b as c}from"./GridCol-CZ1kaCX1.js";const p={title:"Komponenter/Grid/GridRow",component:s,argTypes:{as:{control:"select",options:["div","span"]}}},n={args:{margin:"sm",padding:"sm",sm:{margin:"sm",padding:"sm"},md:{margin:"sm",padding:"sm"},lg:{margin:"sm",padding:"sm"}},render:a=>r.createElement(l,null,r.createElement(s,{...a},r.createElement(c,null,"innehold")))},e={args:{...n.args,background:"syrin-70",backgroundDark:"natt"},render:a=>r.createElement(l,null,r.createElement(s,{...a},r.createElement(c,{sm:12,lg:{cols:6,offset:3}},"innehold")))};var d,o,t;n.parameters={...n.parameters,docs:{...(d=n.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
    margin: 'sm',
    padding: 'sm',
    sm: {
