import{c as E}from"./index-QCImZZ3W.js";import{r as C,R as e}from"./index-DQDNmYQF.js";import{L as T}from"./Label-B7lv4noR.js";import{T as m}from"./Tooltip-BmnhgMk7.js";import{E as h}from"./ErrorFieldMessage-eNbkZ9Td.js";const N=(o,a)=>typeof o=="function"?o(a):e.isValidElement(o)?e.cloneElement(o,a):o,I=({inputId:o,children:a,className:g,extraMargin:f=!0,description:s,label:i,fieldMessage:n,tooltip:t,onTooltipToggle:c,labelId:l,...y})=>{const b=C.useId(),r=o??b,p=s?`${r}-description`:void 0;if(e.Children.count(a)>1)throw new Error("This element does not support more than one child. If you need more than one element inside your InputGroup, please use the function-as-a-child pattern outlined in the documentation.");const d=(()=>{var u;return typeof n=="string"?`${r}-fieldmessage`:(u=n==null?void 0:n.props)!=null&&u.id?n.props.id:n?`${r}-fieldmessage`:void 0})();if(c&&typeof t!="boolean"&&typeof t!="string")throw new Error(`Only use the "onTooltipToggle" prop if you're not sending a component of type <Tooltip /> in the "tooltip" prop. If you are, use "onClick" on that component instead`);if(t&&s)throw new Error(`Don't use both "tooltip" and "description" on an <InputGroup />, pick one of them`);const k=!!n&&(typeof n=="string"||n.type===h),R=!!n,v=d||p?[d,p].filter(Boolean).join(" "):void 0,w=N(a,{id:r,"aria-invalid":k?"true":"false","aria-describedby":v});return e.createElement("div",{className:E("ffe-input-group",{"ffe-input-group--no-extra-margin":!f,"ffe-input-group--message":R},g),...y},e.createElement("div",{className:"ffe-input-group__header"},typeof i=="string"?e.createElement(T,{htmlFor:r,id:l},i):e.isValidElement(i)&&e.cloneElement(i,{htmlFor:r,id:l}),typeof t=="string"&&e.createElement(m,{onClick:c},t),t===!0&&e.createElement(m,{onClick:c}),e.isValidElement(t)&&t),s&&e.createElement("div",{className:"ffe-small-text ffe-input-group__description",id:p},s),w,typeof n=="string"&&e.createElement(h,{as:"p",id:d},n),e.isValidElement(n)&&e.cloneElement(n,{id:d}))};I.__docgenInfo={description:"",methods:[],displayName:"InputGroup",props:{inputId:{required:!1,tsType:{name:"string"},description:"The id that will be used on the input child if you don't want a generated one"},labelId:{required:!1,tsType:{name:"string"},description:"The id used on the label in this component. Could be necessary if your component needs a aria-labelledby."},children:{required:!0,tsType:{name:"union",raw:`| NonNullable<React.ReactNode>
