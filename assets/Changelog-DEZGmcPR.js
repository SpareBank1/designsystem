import{j as e,M as t}from"./index-DS2EldHB.js";import{useMDXComponents as i}from"./index-DmqVK_gK.js";import"./iframe-Foi68yMA.js";import"./index-DQDNmYQF.js";import"./index-DMkFJtLM.js";import"./index-CFFhkS_s.js";import"./index-DgH-xKnr.js";import"./index-DrFu-skq.js";function s(n){const r={a:"a",br:"br",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...i(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{title:"Introduksjon/Changelog"}),`
`,e.jsx(r.h1,{id:"changelog",children:"Changelog"}),`
`,e.jsxs(r.p,{children:["Denne siden lister breaking changes og større endringer i designsystemet. Du finner fullstendig changelog på ",e.jsx(r.a,{href:"https://github.com/SpareBank1/designsystem/releases",rel:"nofollow",children:"releasesiden på GitHub"}),"."]}),`
`,e.jsx(r.h3,{id:"10100-avhengighetsopprydning-og-bugfikser-apr-2026",children:"101.0.0 Avhengighetsopprydning og bugfikser (apr 2026)"}),`
`,e.jsxs(r.p,{children:["Denne versjonen er en ",e.jsx(r.strong,{children:"major"})," release primært drevet av oppgradering av interne avhengigheter til nye major-versjoner. Vi anbefaler å følge ekstra med på eventuelle feil etter oppdatering, slik som med alle major-versjoner."]}),`
`,e.jsxs(r.p,{children:[e.jsx(r.strong,{children:"Avhengighetsopprydning (alle pakker)"}),`
Mange pakker har fått ryddet opp i avhengighetslistene: unødvendige pakker er fjernet, og flere er flyttet fra `,e.jsx(r.code,{children:"dependencies"})," til ",e.jsx(r.code,{children:"devDependencies"})," eller ",e.jsx(r.code,{children:"peerDependencies"}),". Dette reduserer størrelsen på ",e.jsx(r.code,{children:"node_modules"})," og install-tid for konsumenter. Ingen API-endringer."]}),`
`,e.jsxs(r.p,{children:[e.jsx(r.strong,{children:e.jsx(r.code,{children:"ffe-searchable-dropdown-react"})}),`
Fjernet `,e.jsx(r.code,{children:"react-custom-scrollbars-4"})," til fordel for en ren CSS-tilnærming for scroll-styling. Dette er en intern endring — konsumenter trenger ikke gjøre noe."]}),`
`,e.jsx(r.p,{children:e.jsx(r.strong,{children:e.jsx(r.code,{children:"ffe-datepicker-react"})})}),`
`,e.jsxs(r.ul,{children:[`
`,e.jsxs(r.li,{children:[e.jsx(r.code,{children:"keydown"}),"-events bobler nå opp fra SpinButton-inputfelter. Dette er en bugfiks og bør ikke gi nye problemer."]}),`
`,e.jsxs(r.li,{children:[e.jsx(r.code,{children:"uuid"}),"-avhengighet fjernet til fordel for ",e.jsx(r.code,{children:"Math.random"})," for ID-generering."]}),`
`]}),`
`,e.jsxs(r.p,{children:[e.jsx(r.strong,{children:e.jsx(r.code,{children:"ffe-datepicker"})}),`
Visuell fokusindikator på kalenderknappen er nå synlig og korrekt.`]}),`
`,e.jsxs(r.p,{children:[e.jsx(r.strong,{children:e.jsx(r.code,{children:"ffe-buttons"})}),`
Lagt til `,e.jsx(r.code,{children:"-webkit-appearance: none"})," for bedre kompatibilitet på iOS/Safari."]}),`
`,e.jsxs(r.p,{children:[e.jsx(r.strong,{children:"Linting"}),`
`,e.jsx(r.code,{children:"eslint-plugin-react-hooks"})," er oppgradert fra v5 til v7. Konsumenter som bruker denne pluginen direkte bør oppdatere peer dep til ",e.jsx(r.code,{children:"^7.0.0"}),"."]}),`
`,e.jsxs(r.p,{children:["Fullstendig liste over endringer finnes på ",e.jsx(r.a,{href:"https://github.com/SpareBank1/designsystem/releases/tag/v101.0.0",rel:"nofollow",children:"releasesiden på GitHub"}),"."]}),`
`,e.jsx(r.h3,{id:"10070-skeleton-komponent-des-2025",children:"100.7.0 Skeleton komponent (des 2025)"}),`
`,e.jsxs(r.p,{children:["Vi tilbyr nå en ny komponent, ",e.jsx(r.code,{children:"<Skeleton>"}),`, som kan brukes som plassholder mens innhold laster. Den kan brukes til å lage forskjellige former og størrelser.
Fullstendig dokumentasjon finner du på `,e.jsx(r.a,{href:"/?path=/docs/komponenter-skeleton--docs",children:"siden for Skeleton"}),"."]}),`
`,e.jsx(r.h3,{id:"10060-deaktivering-av-spesifikke-datoer-i-datepicker-nov-2025",children:"100.6.0 Deaktivering av spesifikke datoer i Datepicker (nov 2025)"}),`
`,e.jsxs(r.p,{children:["Lagt til propen ",e.jsx(r.code,{children:"disabledDates?: string[]"})," i Datepicker-komponenten som gjør det mulig å deaktivere spesifikke datoer."]}),`
`,e.jsx(r.h3,{id:"10050-tilbakemeldingskomponent-godtar-headinglooklike-nov-2025",children:"100.5.0 Tilbakemeldingskomponent godtar headingLookLike (nov 2025)"}),`
`,e.jsxs(r.p,{children:["Det er nå mulig å sette ",e.jsx(r.code,{children:"headingLookLike"})," på ",e.jsx(r.code,{children:"<Feedback>"}),"-komponenten for å endre utseendet på overskriften i tilbakemeldingsboksen. Dette gjør det enklere å tilpasse komponenten til ulike designbehov."]}),`
`,e.jsx(r.h3,{id:"10041-justeringer-i-noen-farger-liten-endring-okt-2025",children:"100.4.1 Justeringer i noen farger (liten endring) (okt 2025)"}),`
`,e.jsx(r.p,{children:`Vi har gjort noen justeringer i fargene for å bedre kontrasten i enkelte tilfeller. I fargesystemet nå har vi et primitivt lag, et semantisk lag og et kontekstlag.
Det er fargene i kontekstlaget som brukes i komponentene og som dere har tilgang til.`}),`
`,e.jsxs(r.p,{children:[`Fargeendringene som er gjort i det semantiske laget (se nederst) får følger for disse variablene i kontekstlaget:
`,e.jsx(r.code,{children:"--ffe-color-fill-secondary-subtle"})," og ",e.jsx(r.code,{children:"--ffe-color-fill-tertiary-subtle"})]}),`
`,e.jsx(r.p,{children:"I tillegg er det gjort justeringer på disse fargene i kontekst-laget:"}),`
`,e.jsxs("table",{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Variabel"}),e.jsx("th",{children:"Endret fra"}),e.jsx("th",{children:"Endret til"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"--ffe-color-fill-feedback-info-subtle"})}),e.jsx("td",{children:e.jsx("code",{children:"default-feedback-info-subtlest"})}),e.jsx("td",{children:e.jsx("code",{children:"-subtler"})})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"--ffe-color-fill-feedback-success-subtle"})}),e.jsx("td",{children:e.jsx("code",{children:"default-feedback-success-subtlest"})}),e.jsx("td",{children:e.jsx("code",{children:"-subtler"})})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"--ffe-color-fill-warning-info-subtle"})}),e.jsx("td",{children:e.jsx("code",{children:"default-warning-info-subtlest"})}),e.jsx("td",{children:e.jsx("code",{children:"-subtler"})})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"--ffe-color-fill-critical-success-subtle"})}),e.jsx("td",{children:e.jsx("code",{children:"default-feedback-critical-subtlest"})}),e.jsx("td",{children:e.jsx("code",{children:"-subtler"})})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"--ffe-color-fill-tip-success-subtle"})}),e.jsx("td",{children:e.jsx("code",{children:"default-feedback-tip-subtlest"})}),e.jsx("td",{children:e.jsx("code",{children:"-subtler"})})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"ffe-color-fill-primary-subtle"})}),e.jsx("td",{children:e.jsx("code",{children:"default-brand-primary-subtlest"})}),e.jsx("td",{children:e.jsx("code",{children:"-subtler"})})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"ffe-color-fill-primary-subtle-hover"})}),e.jsx("td",{children:e.jsx("code",{children:"default-brand-primary-subtler"})}),e.jsx("td",{children:e.jsx("code",{children:"-subtle"})})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("code",{children:"ffe-color-fill-primary-subtle-pressed"})}),e.jsx("td",{children:e.jsx("code",{children:"default-brand-primary-subtle"})}),e.jsx("td",{children:e.jsx("code",{children:"-default"})})]})]})]}),`
`,e.jsx(r.p,{children:"Dette får en veldig liten justering i disse komponentene:"}),`
`,e.jsxs(r.ul,{children:[`
`,e.jsx(r.li,{children:"Chips hover og pressed"}),`
`,e.jsx(r.li,{children:"Tabs hover og pressed"}),`
`,e.jsx(r.li,{children:"Spinner bakgrunnsfarge"}),`
`,e.jsx(r.li,{children:"Progressbar bar"}),`
`,e.jsx(r.li,{children:"Tags subtle"}),`
`,e.jsx(r.li,{children:"Datepicker bakgrunnsfarge på dato i inputfeltet"}),`
`,e.jsx(r.li,{children:"Tooltip bakgrunnsfarge"}),`
`]}),`
`,e.jsx(r.p,{children:"Fargeendringene som er gjort i det semantsike laget er gjort på:"}),`
`,e.jsxs(r.ul,{children:[`
`,e.jsx(r.li,{children:e.jsx(r.code,{children:"ffe-color-default-brand-secondary-subtlest"})}),`
`,e.jsx(r.li,{children:e.jsx(r.code,{children:"ffe-color-default-brand-secondary-subtler"})}),`
`,e.jsx(r.li,{children:e.jsx(r.code,{children:"ffe-color-default-brand-tertiary-subtlest"})}),`
`,e.jsx(r.li,{children:e.jsx(r.code,{children:"ffe-color-default-brand-tertiary-subtler"})}),`
`]}),`
`,e.jsx(r.p,{children:"Alle verdiene er veldig små justeringer, stort sett endret 25 hakk opp eller ned på en skala fra 0-1000."}),`
`,e.jsx(r.h2,{id:"ny-komponent-textfield-sept-2025",children:"Ny komponent: TextField (sept 2025)"}),`
...
`})}),`
`,e.jsxs(r.p,{children:["Da blir fargene tilgjengelige i kebab-case uten ",e.jsx(r.code,{children:"--ffe-color"}),". Feks ",e.jsx(r.code,{children:"--ffe-color-background-default"})," -> ",e.jsx(r.code,{children:"background-default"})]})]})}function j(n={}){const{wrapper:r}={...i(),...n.components};return r?e.jsx(r,{...n,children:e.jsx(s,{...n})}):s(n)}export{j as default};
