import{R as e}from"./index-DQDNmYQF.js";import{c as g}from"./index-QCImZZ3W.js";import{f as N,W as x}from"./WithCardAction-BEfhMYaK.js";import{C as y,T as S,S as _,a as k}from"./Title-CmDdbz_O.js";function I(t,a){const{className:r,condensed:l,img:o,illustrationPosition:c,noMargin:b,children:d,...h}=t;return e.createElement(x,{baseClassName:"ffe-illustration-card",className:g("ffe-illustration-card",{"ffe-illustration-card--condensed":l},{"ffe-illustration-card--no-margin":b},{"ffe-illustration-card--right":c==="right"},r),...h,ref:a},({CardAction:R})=>{const m=e.createElement("div",{className:g("ffe-illustration-card__illustration")},o),u=e.createElement("div",{className:"ffe-illustration-card__body"},typeof d=="function"?d({Text:k,Subtext:_,Title:S,CardName:y,CardAction:R}):d);return c==="right"?e.createElement(e.Fragment,null,u,m):e.createElement(e.Fragment,null,m,u)})}const i=N(I);i.__docgenInfo={description:"",methods:[],displayName:"IllustrationCard",props:{img:{required:!0,tsType:{name:"ReactElement"},description:"Element of illustration"},condensed:{required:!1,tsType:{name:"boolean"},description:"Smaller illustration and less space"},illustrationPosition:{required:!1,tsType:{name:"union",raw:"'right' | 'left'",elements:[{name:"literal",value:"'right'"},{name:"literal",value:"'left'"}]},description:"Position illustration at left (default) or right of the card content"},noMargin:{required:!1,tsType:{name:"boolean"},description:"No margin on card"},children:{required:!0,tsType:{name:"union",raw:`| React.ReactNode
