import{r as f,R as e}from"./index-DQDNmYQF.js";import{c as i}from"./index-D2FocPV0.js";import{T as b}from"./Tooltip-hBpB-Mp_.js";import{E as R}from"./ErrorFieldMessage-3ijRb_jv.js";const y=({children:d,className:c,extraMargin:l=!0,description:a,fieldMessage:t,inline:u,label:r,name:p,selectedValue:m,tooltip:n,onChange:o,...h})=>{if(n&&a)throw new Error(`Don't use both "tooltip" and "description" on an <RadioButtonInputGroup />, pick one of them`);const s=f.useId();return e.createElement("fieldset",{"aria-labelledby":s,className:i("ffe-input-group",{"ffe-input-group--no-extra-margin":!l},{"ffe-input-group--message":!!t},c),...h},r&&e.createElement("legend",{id:s,className:i("ffe-form-label","ffe-form-label--block")},r,typeof n=="string"&&e.createElement(b,null,n),e.isValidElement(n)&&n),a&&e.createElement("div",{className:"ffe-input-group__description ffe-small-text"},a),d({inline:u,name:p,onChange:g=>{o==null||o(g)},selectedValue:m}),typeof t=="string"?e.createElement(R,{as:"p"},t):t)};y.__docgenInfo={description:"",methods:[],displayName:"RadioButtonInputGroup",props:{children:{required:!0,tsType:{name:"signature",type:"function",raw:`(inputProps: {
    inline?: boolean;
    name: string;
