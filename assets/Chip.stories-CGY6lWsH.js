import{R as n}from"./index-RYns6xqu.js";import{C as o}from"./Chip-CzlxOE0a.js";import{f as i,s as p}from"./spacing-enBt7HlE.js";const m={title:"components/chips/Chip",component:o},e={args:{as:"button",children:"Label",size:"sm"},render:r=>n.createElement(o,{...r})},a={args:{...e.args,onColoredBg:!0},decorators:[r=>n.createElement("div",{style:{background:i,padding:p}},n.createElement(r,null))],render:r=>n.createElement(o,{...r})};var s,t,d;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    as: 'button',
    children: 'Label',
    size: 'sm'
