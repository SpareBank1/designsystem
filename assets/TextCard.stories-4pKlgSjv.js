import{R as e}from"./index-DJO9vBfz.js";import{c as f}from"./index-i5X67GZP.js";import{f as x,W as g}from"./WithCardAction--lhCHbxA.js";import{T,S as b,a as C,C as N}from"./Title-3dDIOOEK.js";function R(t,r){const{className:n,leftAlign:o,noMargin:i,children:s,...u}=t;return e.createElement(g,{baseClassName:"ffe-text-card",className:f("ffe-text-card",{"ffe-text-card--left-align":o},{"ffe-text-card--no-margin":i},n),...u,ref:r},({CardAction:p})=>typeof s=="function"?s({Text:T,Subtext:b,Title:C,CardName:N,CardAction:p}):s)}const d=x(R);d.__docgenInfo={description:"",methods:[],displayName:"TextCard",props:{leftAlign:{required:!1,tsType:{name:"boolean"},description:"Left-aligned text on the card"},noMargin:{required:!1,tsType:{name:"boolean"},description:"No margin on card"},children:{required:!0,tsType:{name:"union",raw:`| React.ReactNode
