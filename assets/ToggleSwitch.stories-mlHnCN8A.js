import{r as x,R as e}from"./index-ne9I_3bB.js";import{c as N}from"./index-B6-3w37c.js";import{i as R}from"./i18n-kNgCcl76.js";const d=({children:i,className:a,description:n,hideOnOff:t,onText:r,offText:l,id:C,value:O="on",locale:T="nb",checked:E,...v})=>{const y=x.useId(),g=C??y,u=R[T];return e.createElement("div",{className:N("ffe-toggle-switch",{"ffe-toggle-switch--hide-on-off":t},a)},e.createElement("input",{className:"ffe-toggle-switch__input",type:"checkbox",id:g,value:O,checked:!!E,...v}),e.createElement("label",{className:"ffe-toggle-switch__label",htmlFor:g},e.createElement("span",{className:"ffe-toggle-switch__label-text"},i,n&&e.createElement("span",{className:"ffe-toggle-switch__label-description"},n)),!t&&e.createElement("span",{className:"ffe-toggle-switch__label-off","aria-hidden":"true"},l||u.OFF),e.createElement("span",{className:"ffe-toggle-switch__switch","aria-hidden":"true"}),!t&&e.createElement("span",{className:"ffe-toggle-switch__label-on",id:"test","aria-hidden":"true"},r||u.ON)))};d.__docgenInfo={description:"",methods:[],displayName:"ToggleSwitch",props:{locale:{required:!1,tsType:{name:"union",raw:"'nb' | 'nn' | 'en'",elements:[{name:"literal",value:"'nb'"},{name:"literal",value:"'nn'"},{name:"literal",value:"'en'"}]},description:"A second line of text in the label",defaultValue:{value:"'nb'",computed:!1}},description:{required:!1,tsType:{name:"string"},description:"On/Off text language"},onText:{required:!1,tsType:{name:"string"},description:"Custom text to specify the on-option"},offText:{required:!1,tsType:{name:"string"},description:"Custom text to specify the off-option"},hideOnOff:{required:!1,tsType:{name:"boolean"},description:"Hide On & Off labels next to switch"},value:{required:!1,tsType:{name:"string"},description:"Override the value attribute of the input with a custom one",defaultValue:{value:"'on'",computed:!1}}}};const q={title:"Komponenter/Form/ToggleSwitch",component:d},s={args:{children:"Jeg vil gjerne ha reklame"},render:function(a){const[n,t]=e.useState(!0);return e.createElement(d,{...a,checked:n,onChange:r=>t(r.target.checked)})}},c={args:{...s.args,hideOnOff:!0},render:function(a){const[n,t]=e.useState(!0);return e.createElement(d,{...a,checked:n,onChange:r=>t(r.target.checked)})}},o={args:{...s.args,description:"Send meg spam"},render:function(a){const[n,t]=e.useState(!0);return e.createElement(d,{...a,checked:n,onChange:r=>t(r.target.checked)})}};var h,m,f;s.parameters={...s.parameters,docs:{...(h=s.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
