import{R as e}from"./index-RYns6xqu.js";import{M as i}from"./MessageHeader-D-5XdHj2.js";import{t as f,C as b,M as v}from"./Content-CQCyX94A.js";import{c as M}from"./index-Dejnh_W_.js";const r=({type:a,header:n,iconFileUrl:m,children:c,locale:d="nb",onColoredBg:u,className:g,...p})=>e.createElement("div",{className:M("ffe-message","ffe-message--box",`ffe-message--${a}`,{"ffe-message--colored-bg":u},g),role:a==="error"?"alert":"group","aria-label":f[d][a].ariaLabel,...p},e.createElement("div",{className:"ffe-message__background"},e.createElement(b,null,typeof n=="string"?e.createElement(i,{as:"h2"},n):n,c)),e.createElement(v,{iconFileUrl:m}));r.__docgenInfo={description:"",methods:[],displayName:"MessageBox",props:{iconFileUrl:{required:!1,tsType:{name:"string"},description:"url to svg icon to override default"},header:{required:!1,tsType:{name:"union",raw:"React.ReactElement<MessageHeaderProps> | string",elements:[{name:"ReactReactElement",raw:"React.ReactElement<MessageHeaderProps>",elements:[{name:"intersection",raw:`{
    as?: As;
} & DistributiveOmit<
...
}`,...(l=(o=s.parameters)==null?void 0:o.docs)==null?void 0:l.source}}};const h=["Standard"],_=Object.freeze(Object.defineProperty({__proto__:null,Standard:s,__namedExportsOrder:h,default:y},Symbol.toStringTag,{value:"Module"}));export{_ as M,s as S};
