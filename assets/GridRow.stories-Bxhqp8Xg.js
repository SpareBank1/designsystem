import{R as r}from"./index-DJO9vBfz.js";import{a as s,G as c,b as l}from"./GridCol-CASG6rvY.js";const p={title:"components/grid/GridRow",component:s,argTypes:{as:{control:"select",options:["div","span"]}}},n={args:{margin:"sm",padding:"sm",sm:{margin:"sm",padding:"sm"},md:{margin:"sm",padding:"sm"},lg:{margin:"sm",padding:"sm"}},render:e=>r.createElement(c,null,r.createElement(s,{...e},r.createElement(l,null,"innehold")))},a={args:{...n.args,background:"syrin-70",backgroundDark:"natt"},render:e=>r.createElement(c,null,r.createElement(s,{...e},r.createElement(l,{sm:12,lg:{cols:6,offset:3}},"innehold")))};var d,o,t;n.parameters={...n.parameters,docs:{...(d=n.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
    margin: 'sm',
    padding: 'sm',
    sm: {
