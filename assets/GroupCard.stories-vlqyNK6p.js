import{R as e}from"./index-DQDNmYQF.js";import{c as k}from"./index-QCImZZ3W.js";import{f,W as G}from"./WithCardAction-BEfhMYaK.js";import{C as b,T as R,S as N,a as T}from"./Title-CmDdbz_O.js";import{b as g}from"./Heading-afd3onnD.js";import{P as y}from"./Paragraph-DEYlXMQQ.js";function K(t,r){const{className:a,children:n,bgColor:d="primary",noMargin:l,as:s="div",...m}=t;return e.createElement(s,{className:k("ffe-group-card",{"ffe-group-card--no-margin":l,[`ffe-group-card--bg-${d}`]:d},a),role:s==="div"?"group":void 0,...m,ref:r},n)}const p=f(K);p.__docgenInfo={description:"",methods:[],displayName:"GroupCard",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"The children of the GroupCard component"},bgColor:{required:!1,tsType:{name:"union",raw:"'primary' | 'secondary' | 'tertiary'",elements:[{name:"literal",value:"'primary'"},{name:"literal",value:"'secondary'"},{name:"literal",value:"'tertiary'"}]},description:"The background color of the whole groupcard element\n\nProperty has new values that work with dark and accent mode as part of the Semantic Color update\nPossible values: `primary` `secondary` `tertiary`\n[Read more in the upgrade guide](https://sparebank1.github.io/designsystem/?path=/docs/introduksjon-changelog--docs#2025---februar---semantiske-farger)"},bgDarkmodeColor:{required:!1,tsType:{name:"never"},description:`@deprecated as part of update to Semantic Colors
...
}`,...(w=(v=c.parameters)==null?void 0:v.docs)==null?void 0:w.source}}};var F,L,H;u.parameters={...u.parameters,docs:{...(F=u.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
    as: 'ul'
  },
  render: args => <GroupCard {...args}>
...
}`,...(H=(L=u.parameters)==null?void 0:L.docs)==null?void 0:H.source}}};var D,q,x;C.parameters={...C.parameters,docs:{...(D=C.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
    ...Standard.args
  },
  render: args => <GroupCard {...args}>
