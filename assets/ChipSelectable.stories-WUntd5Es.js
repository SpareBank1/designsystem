...
[Read more in the upgrade guide](https://sparebank1.github.io/designsystem/?path=/docs/introduksjon-changelog--docs#2025---februar---semantiske-farger)`},isSelected:{required:!1,tsType:{name:"boolean"},description:"Whether this chips is selected"}}};const E={title:"Komponenter/Chips/ChipSelectable",component:s},a={args:{as:"button",size:"sm"},render:t=>e.createElement("div",{className:"storybook-button-display-group"},e.createElement(s,{...t},"Chip"),e.createElement(s,{...t,isSelected:!0},"Selected Chip"))};var r,o,i;a.parameters={...a.parameters,docs:{...(r=a.parameters)==null?void 0:r.docs,source:{originalSource:`{
  args: {
    as: 'button',
    size: 'sm'
  },
...
}`,...(i=(o=a.parameters)==null?void 0:o.docs)==null?void 0:i.source}}};const I=["Standard"];export{a as Standard,I as __namedExportsOrder,E as default};
