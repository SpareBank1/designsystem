import{R as e}from"./index-DQDNmYQF.js";import{T as t}from"./TertiaryButton-CQPQX3mi.js";import{a as T,b as k,c as b}from"./IconExamples-DKeTo_Gz.js";import{I as i}from"./Icon-D_nm5xPy.js";const z=r=>e.createElement("a",{...r},"Custom ",r.children),B={title:"Komponenter/Buttons/TertiaryButton",component:t,argTypes:{as:{options:["a","button","custom"],mapping:{"":"button",a:"a",button:"button",custom:z}}}},a={args:{},render:r=>e.createElement(t,{...r},"Tertiærknapp")},n={args:{},render:r=>e.createElement("div",{className:"storybook-button-display-group"},e.createElement(t,{...r,size:"lg"},"Stor tertiærknapp"),e.createElement(t,{...r},"Tertiærknapp"),e.createElement(t,{...r,size:"sm"},"Liten tertiærknapp"))},o={args:{iconOnly:!0},render:r=>e.createElement("div",{className:"storybook-button-display-group"},e.createElement(t,{...r,size:"lg","aria-label":"Stor tertiærknapp med ikon"},e.createElement(i,{fileUrl:T,size:"lg"})),e.createElement(t,{...r,size:"md","aria-label":"Vanlig tertiærknapp med ikon"},e.createElement(i,{fileUrl:k,size:"md"})),e.createElement(t,{...r,size:"sm","aria-label":"Liten tertiærknapp med ikon"},e.createElement(i,{fileUrl:b,size:"sm"})))};var s,c,l;a.parameters={...a.parameters,docs:{...(s=a.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {},
