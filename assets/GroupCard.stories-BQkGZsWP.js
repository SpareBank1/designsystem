import{R as e}from"./index-ne9I_3bB.js";import{c as f}from"./index-B6-3w37c.js";import{f as E,W as k}from"./WithCardAction-Bpdr1y6g.js";import{C as R,T as b,S as T,a as N}from"./Title-DlaSx2JZ.js";import{H as g}from"./Heading-C4V8mJFT.js";import{P as _}from"./Paragraph-CgekKyFC.js";function L({shadow:n,className:r,children:d,bgColor:l,bgDarkmodeColor:o,noMargin:a,...p},m){return e.createElement("div",{className:f("ffe-group-card",{"ffe-group-card--shadow":n,"ffe-group-card--no-margin":a,[`ffe-group-card--bg-${l}`]:l,[`ffe-group-card--dm-bg-${o}`]:o},r),role:"group",...p,ref:m},d)}const i=E(L);i.__docgenInfo={description:"",methods:[],displayName:"GroupCard",props:{shadow:{required:!1,tsType:{name:"boolean"},description:""},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"The children of the GroupCard component"},bgColor:{required:!1,tsType:{name:"union",raw:`| 'sand-30'
| 'sand-70'
| 'frost-30'
| 'syrin-30'
