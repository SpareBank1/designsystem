import{R as e}from"./index-eCxJ45ll.js";import{c as f}from"./index-DezCrw0f.js";import{f as T,W as b}from"./WithCardAction-D8xJ0iKc.js";import{C as x,T as C,S as N,a as S}from"./Title-Q79Fy4wU.js";function E(a,n){const{className:r,imageSrc:i,imageAltText:o,noMargin:u,children:m,...g}=a;return e.createElement(b,{baseClassName:"ffe-image-card",className:f("ffe-image-card",{"ffe-image-card--no-margin":u},r),...g,ref:n},({CardAction:p})=>e.createElement(e.Fragment,null,e.createElement("div",{className:"ffe-image-card__image-container"},e.createElement("div",{className:"ffe-image-card__image-overlay"}),e.createElement("img",{src:i,alt:o,className:"ffe-image-card__image"})),e.createElement("div",{className:"ffe-image-card__body"},typeof m=="function"?m({Text:S,Subtext:N,Title:C,CardName:x,CardAction:p}):m)))}const s=T(E);s.__docgenInfo={description:"",methods:[],displayName:"ImageCard",props:{imageSrc:{required:!0,tsType:{name:"string"},description:"The src for the image"},imageAltText:{required:!0,tsType:{name:"string"},description:"The alt text for the image"},noMargin:{required:!1,tsType:{name:"boolean"},description:"No margin on card"},children:{required:!0,tsType:{name:"union",raw:`| React.ReactNode
