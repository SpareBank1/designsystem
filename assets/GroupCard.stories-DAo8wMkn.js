...
| ((cardRenderProps: CardRenderProps) => React.ReactNode)`,elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"unknown"}]},description:""}}};const M=t=>e.createElement("div",{...t},"Custom ",t.children),O={title:"Komponenter/Cards/GroupCard",component:m,argTypes:{as:{options:["span","div","custom"],mapping:{div:"div",span:"span",custom:M}}}},i={args:{as:"div"},render:t=>e.createElement(m,{...t},e.createElement(h,null,e.createElement(g,{lookLike:5},"Tittel på gruppe")),e.createElement(o,null,"Dette er et element i GroupCard"),e.createElement(o,null,"Dette er et element i GroupCard"),e.createElement(o,null,"Dette er et element i GroupCard"),e.createElement(E,null,({CardAction:r})=>e.createElement(r,{href:"https://design.sparebank1.no"},"Vis mer")))},c={args:{...i.args},render:t=>e.createElement(m,{...t},e.createElement(h,{noSeparator:!0},e.createElement(g,{lookLike:5},"Tittel på gruppe")),e.createElement(o,{noSeparator:!0},"Dette er et element i GroupCard en linje mellom elementene"),e.createElement(o,{noSeparator:!0},"Dette er et element i GroupCard en linje mellom elementene"),e.createElement(o,{noSeparator:!0},"Dette er et element i GroupCard en linje mellom elementene"),e.createElement(E,null,"Footer"))},u={args:{as:"ul"},render:t=>e.createElement(m,{...t},e.createElement(o,{as:"li"},({CardAction:r,CardName:a,Title:n})=>e.createElement(e.Fragment,null,e.createElement(a,null,"Kortnavn"),e.createElement(n,null,e.createElement(r,{href:"https://design.sparebank1.no"},"Lenke men hele kortet er klikkbart")))),e.createElement(o,{as:"li"},"Dette er ett ikke-klikkbart liste element i GroupCard"),e.createElement(o,{as:"li"},({CardAction:r,CardName:a,Title:n})=>e.createElement(e.Fragment,null,e.createElement(a,null,"Kortnavn"),e.createElement(n,null,e.createElement(r,{href:"https://design.sparebank1.no"},"Lenke men hele kortet er klikkbart")))),e.createElement(o,{as:"li"},({CardAction:r,CardName:a,Title:n})=>e.createElement(e.Fragment,null,e.createElement(a,null,"Kortnavn"),e.createElement(n,null,e.createElement(r,{href:"https://design.sparebank1.no"},"Lenke men hele kortet er klikkbart")))))},C={args:{...i.args},render:t=>e.createElement(m,{...t},e.createElement(h,null,e.createElement(g,{lookLike:5},"Tittel på gruppe")),e.createElement(o,null,({CardAction:r,CardName:a,Title:n,Subtext:d,Text:l})=>e.createElement(e.Fragment,null,e.createElement(a,null,"Kortnavn"),e.createElement(n,null,e.createElement(r,{href:"https://design.sparebank1.no"},"Lenke men hele kortet er klikkbart")),e.createElement(d,null,"En liten undertekst"),e.createElement(l,null,"Her kan man ha tekst"))),e.createElement(o,null,({CardAction:r})=>e.createElement(e.Fragment,null,e.createElement(g,null,e.createElement(r,{as:"button"},"Knapp")),e.createElement(y,null,"Hele kortet er klikkbart"))),e.createElement(o,null,({CardAction:r})=>e.createElement(e.Fragment,null,e.createElement(g,null,e.createElement(r,{href:"https://design.sparebank1.no"},"Lenke")),e.createElement(y,null,"Hele kortet er klikkbart"))),e.createElement(E,null,({CardAction:r})=>e.createElement(r,{href:"https://design.sparebank1.no"},"Vis mer")))};var _,S,v;i.parameters={...i.parameters,docs:{...(_=i.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    as: 'div'
  },
...
}`,...(v=(S=i.parameters)==null?void 0:S.docs)==null?void 0:v.source}}};var A,P,w;c.parameters={...c.parameters,docs:{...(A=c.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    ...Standard.args
  },
  render: args => <GroupCard {...args}>
...
}`,...(w=(P=c.parameters)==null?void 0:P.docs)==null?void 0:w.source}}};var F,H,L;u.parameters={...u.parameters,docs:{...(F=u.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
    as: 'ul'
  },
  render: args => <GroupCard {...args}>
