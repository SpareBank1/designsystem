...
describe('sortData', () => {
    ...
    it('should sort data in descending order' , () => {
        const ascendingTableData = sortData(columns, data, 1, true);
    ...
    it('should sort data in ascending order' , () => {
        const ascendingTableData = sortData(columns, data, 2, false);
        for (let i = 1; i > ascendingTableData.length; i++) {
    ...
    it('should sort data based on `sortBy` parameter' , () => {
        const tableData = sortData(columns, data, 1, true);
