...
Eller se [releasesiden på GitHub](https://github.com/SpareBank1/designsystem/releases) for en oversikt over alle versjoner.

## 100.7.0

- ffe-skeleton-react: Legg til skeleton komponent
- ffe-skeleton: Legg til skeleton komponent

## 100.6.0

- ffe-datepicker-react: legg til feature for å disable dates i kalenderen

## 100.5.0

- ffe-feedback-react: Tilbakemeldingskomponent godtar headingLookLike
