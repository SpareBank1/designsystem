import { Paragraph, LinkText, SmallText, PreformattedText, EmphasizedText, Heading1, Heading2, Heading3, Heading4, Heading5, Heading6, StrongText, DividerLine, MicroText } from '../../_snowpack/link/packages/ffe-core-react/es/index.js';
import { Grid, GridRow, GridCol, InlineGrid } from '../../_snowpack/link/packages/ffe-grid-react/es/index.js';
import { SnakkebobleIkon, HandlevognIkon, HakeIkon, KryssIkon, HusIkon, BilIkon, SparegrisIkon, KryssSirkelIkon, GrafOppIkon, BindersIkon, PlussIkon, UtropstegnIkon, LyspareIkon, InfoIkon } from '../../_snowpack/link/packages/ffe-icons-react/es/index.js';
import { useState } from '../../_snowpack/pkg/react.js';
import { AccountSelector, AccountSelectorMulti } from '../../_snowpack/link/packages/ffe-account-selector-react/es/index.js';
import { InputGroup, Label, Checkbox, Input, TextArea, SuccessFieldMessage, ErrorFieldMessage, Tooltip, InfoFieldMessage, PhoneNumber, RadioButton, RadioButtonInputGroup, RadioSwitch, RadioBlock } from '../../_snowpack/link/packages/ffe-form-react/es/index.js';
import Spinner from '../../_snowpack/link/packages/ffe-spinner-react/es/index.js';
import { StylizedNumberedList, StylizedNumberedListItem, DescriptionList, DescriptionListTerm, DescriptionListDescription, DescriptionListMultiCol, CheckList, CheckListItem, NumberedList, NumberedListItem, BulletList, BulletListItem } from '../../_snowpack/link/packages/ffe-lists-react/es/index.js';
import Dropdown from '../../_snowpack/link/packages/ffe-dropdown-react/es/index.js';
import { SystemSuccessMessage, SystemInfoMessage, SystemNewsMessage, SystemErrorMessage } from '../../_snowpack/link/packages/ffe-system-message-react/es/index.js';
import { ErrorMessage, InfoMessage, InfoMessageList, InfoMessageListItem, SuccessMessage, TipsMessage } from '../../_snowpack/link/packages/ffe-message-box-react/es/index.js';
import Table from '../../_snowpack/link/packages/ffe-tables-react/es/index.js';
import { TertiaryButton, SecondaryButton, ButtonGroup, PrimaryButton, ExpandButton, ActionButton, ShortcutButton, TaskButton, BackButton, InlineExpandButton } from '../../_snowpack/link/packages/ffe-buttons-react/es/index.js';
import ChartDonut from '../../_snowpack/link/packages/ffe-chart-donut-react/es/index.js';
import Datepicker, { Calendar } from '../../_snowpack/link/packages/ffe-datepicker-react/es/index.js';
import { formatPercentage, formatFodselsnummer, formatDate, formatAccountNumber, formatNumber, formatCurrency, formatDistance } from '../../_snowpack/link/packages/ffe-formatters/es/index.js';
import { TabButton, TabButtonGroup, Tab, TabGroup } from '../../_snowpack/link/packages/ffe-tabs-react/es/index.js';
import { IconCard, TextCard, ImageCard, CardBase } from '../../_snowpack/link/packages/ffe-cards-react/es/index.js';
import { DetailList, Detail, DetailContent } from '../../_snowpack/link/packages/ffe-details-list-react/es/index.js';
import FileUpload from '../../_snowpack/link/packages/ffe-file-upload-react/es/index.js';
import Collapse from '../../_snowpack/link/packages/ffe-collapse-react/es/index.js';
import { Accordion, AccordionItem } from '../../_snowpack/link/packages/ffe-accordion-react/es/index.js';
import SearchableDropdown from '../../_snowpack/link/packages/ffe-searchable-dropdown-react/es/index.js';
import { ContextTipMessage, ContextInfoMessage, ContextErrorMessage, ContextSuccessMessage } from '../../_snowpack/link/packages/ffe-context-message-react/es/index.js';
...
const scope$2J = {PreformattedText};
...
const scope$2H = {Heading1,Heading2,Heading3,Heading4,Heading5,Heading6};
...
const scope$2E = {LinkText,SnakkebobleIkon};
...
const scope$2C = {useState,AccountSelector,InputGroup,SmallText};
...
const scope$2B = {useState,AccountSelector,InputGroup};
...
const scope$2A = {useState,AccountSelector,InputGroup};
...
const scope$2z = {useState,AccountSelector,InputGroup};
...
const scope$2y = {useState,AccountSelector,InputGroup};
...
const scope$2x = {useState,AccountSelectorMulti,Label};
...
const scope$2w = {Spinner,Paragraph};
...
const scope$2u = {StylizedNumberedList,StylizedNumberedListItem};
...
const scope$2t = {DescriptionList,DescriptionListTerm,DescriptionListDescription};
...
const scope$2s = {DescriptionList,DescriptionListTerm,DescriptionListDescription};
...
const scope$2r = {DescriptionList,DescriptionListTerm,DescriptionListDescription};
...
const scope$2q = {DescriptionListMultiCol,DescriptionListTerm,DescriptionListDescription};
...
const scope$2p = {CheckList,CheckListItem};
...
const scope$2o = {CheckList,CheckListItem};
const code$2o = "<div>\n    <h3 className=\"ffe-h4\">Ved å bruke FFE får du</h3>\n    <CheckList>\n        <CheckListItem>Massevis av ferdige, testede komponenter</CheckListItem>\n        <CheckListItem>Likt design som resten av SpareBank 1</CheckListItem>\n        <CheckListItem>Høyere utviklingshastighet</CheckListItem>\n        <CheckListItem isCross={true}>Flere bugs</CheckListItem>\n    </CheckList>\n</div>;";
...
const scope$2n = {NumberedList,NumberedListItem};
...
const scope$2m = {BulletList,BulletListItem};
...
const scope$2l = {InlineGrid,GridRow,GridCol};
...
const scope$2k = {useState,Grid,GridRow,GridCol,Dropdown,Label};
...
const scope$2j = {Grid,GridRow,GridCol};
const code$2j = "<Grid>\n    <GridRow>\n        <GridCol sm=\"6\">Litt innhold til venstre</GridCol>\n        <GridCol sm=\"6\">Litt innhold til høyre</GridCol>\n    </GridRow>\n</Grid>;";
...
const scope$2i = {Grid,GridRow,GridCol};
...
const scope$2h = {useState,Grid,GridRow,GridCol,Dropdown,Label};
...
const scope$2g = {InlineGrid,GridRow,GridCol};
...
const scope$2f = {SystemSuccessMessage};
...
const scope$2e = {SystemInfoMessage};
...
const scope$2d = {SystemNewsMessage};
...
const scope$2c = {SystemErrorMessage};
...
const scope$2b = {SystemErrorMessage};
...
const scope$2a = {ErrorMessage,Paragraph};
...
const scope$29 = {InfoMessage,Paragraph};
...
const scope$28 = {InfoMessage,InfoMessageList,InfoMessageListItem};
...
const scope$27 = {SuccessMessage,Paragraph};
...
const scope$26 = {ErrorMessage,Paragraph};
...
const scope$25 = {InfoMessage,Paragraph,HandlevognIkon};
...
const scope$24 = {TipsMessage,Paragraph};
...
const scope$22 = {Table,TertiaryButton};
...
const scope$20 = {Table,TertiaryButton,HakeIkon,KryssIkon};
...
const scope$1Z = {useState,Datepicker,Dropdown,InputGroup,Checkbox,Input,TextArea,SecondaryButton};
...
const scope$1X = {SuccessFieldMessage};
...
const scope$1W = {InputGroup,Input,ErrorFieldMessage};
...
const scope$1T = {useState,Tooltip};
...
const scope$1R = {Input,ButtonGroup,PrimaryButton};
...
const scope$1P = {InputGroup,Input};
...
const scope$1N = {InfoFieldMessage};
...
const scope$1M = {InputGroup,Input,ErrorFieldMessage};
const code$1M = "<>\n    <InputGroup\n        label=\"Fornavn\"\n        fieldMessage=\"Jeg er en string-fieldMessage som gir feilmelding\"\n    >\n        <Input\n            name=\"firstname\"\n            onChange={e => console.log('onChange', e.target.value)}\n            onBlur={e => console.log('onBlur', e.target.value)}\n        />\n    </InputGroup>\n\n    <InputGroup\n        label=\"Etternavn\"\n        fieldMessage={\n            <ErrorFieldMessage>\n                Jeg er en ErrorFieldMessage-fieldMessage som gir feilmelding\n            </ErrorFieldMessage>\n        }\n    >\n        <Input\n            name=\"lastname\"\n            onChange={e => console.log('onChange', e.target.value)}\n            onBlur={e => console.log('onBlur', e.target.value)}\n        />\n    </InputGroup>\n\n    <InputGroup\n        label=\"Telefonnummer\"\n        fieldMessage={\n            <div>Jeg er en div-fieldMessage som ikke gir feilmelding</div>\n        }\n    >\n        <Input\n            name=\"phone\"\n            onChange={e => console.log('onChange', e.target.value)}\n            onBlur={e => console.log('onBlur', e.target.value)}\n        />\n    </InputGroup>\n</>;";
...
const scope$1K = {useState,RadioButton,RadioButtonInputGroup};
...
const scope$1J = {useState,RadioButton,RadioButtonInputGroup};
...
const scope$1I = {Input,Paragraph};
...
const scope$1F = {useState,RadioSwitch,RadioButtonInputGroup};
...
const scope$1E = {TextArea,ButtonGroup,PrimaryButton};
...
const scope$1D = {useState,RadioSwitch,RadioButtonInputGroup};
...
const scope$1C = {useState,RadioBlock,RadioButtonInputGroup};
...
const scope$1B = {useState,RadioSwitch,RadioButtonInputGroup};
...
const scope$1A = {ErrorFieldMessage};
...
const scope$1y = {useState,RadioButton,RadioButtonInputGroup};
...
const scope$1w = {useState,RadioSwitch,RadioButtonInputGroup};
...
const scope$1v = {useState,RadioButtonInputGroup,RadioBlock,RadioSwitch,RadioButton,Tooltip,SecondaryButton};
...
const scope$1t = {useState,RadioButtonInputGroup,RadioBlock,RadioSwitch,RadioButton,Tooltip,SecondaryButton};
const code$1t = "() => {\n    const [showErrors, setShowErrors] = useState(false);\n    const [selectedColor, setSelectedColor] = useState('red');\n    const [selectedSmell, setSelectedSmell] = useState();\n\n    return (\n        <>\n            <div className=\"ffe-button-group\">\n                <SecondaryButton onClick={() => setShowErrors(!showErrors)}>\n                    Skru feilmeldinger av/på\n                </SecondaryButton>\n            </div>\n            <RadioButtonInputGroup\n                label=\"Hva er din favorittfarge?\"\n                inline={true}\n                name=\"color\"\n                fieldMessage={showErrors ? 'Feil farge.' : null}\n                tooltip={\n                    <Tooltip>\n                        Din favorittfarge er viktig for oss. Vår er blå!\n                    </Tooltip>\n                }\n                selectedValue={selectedColor}\n                onChange={e => setSelectedColor(e.target.value)}\n            >\n                {inputProps => (\n                    <>\n                        <RadioButton {...inputProps} value=\"red\">\n                            Rød\n                        </RadioButton>\n                        <RadioButton {...inputProps} value=\"blue\">\n                            Blå\n                        </RadioButton>\n                        <RadioButton {...inputProps} value=\"yellow\">\n                            Gul\n                        </RadioButton>\n                        <p>Ekstra innhold</p>\n                    </>\n                )}\n            </RadioButtonInputGroup>\n\n            <RadioButtonInputGroup\n                label=\"Hva er din favorittlukt?\"\n                inline={true}\n                name=\"smell\"\n                fieldMessage={showErrors ? 'Feil lukt.' : null}\n                selectedValue={selectedSmell}\n                onChange={e => setSelectedSmell(e.target.value)}\n            >\n                {inputProps => (\n                    <>\n                        <RadioButton {...inputProps} value=\"grass\">\n                            Gress\n                        </RadioButton>\n                        <RadioButton {...inputProps} value=\"asphalt\">\n                            Asfalt\n                        </RadioButton>\n                        <RadioButton {...inputProps} value=\"pollen\">\n                            Pollen\n                        </RadioButton>\n                    </>\n                )}\n            </RadioButtonInputGroup>\n\n            <RadioButtonInputGroup\n                description=\"Du kan ikke velge begge\"\n                label=\"Velg ja eller nei\"\n                name=\"switch\"\n                fieldMessage={showErrors ? 'Feil valg' : null}\n            >\n                {inputProps => (\n                    <RadioSwitch\n                        leftLabel=\"Ja\"\n                        leftValue={true}\n                        rightLabel=\"Nei\"\n                        rightValue={false}\n                        {...inputProps}\n                    />\n                )}\n            </RadioButtonInputGroup>\n\n            <RadioButtonInputGroup\n                label=\"Velg ja eller nei\"\n                name=\"block1\"\n                selectedValue=\"yes\"\n                fieldMessage={showErrors ? 'Feil valg' : null}\n            >\n                {inputProps => (\n                    <>\n                        <RadioBlock {...inputProps} label=\"Ja\" value=\"yes\" />\n                        <RadioBlock\n                            {...inputProps}\n                            label=\"Nei\"\n                            showChildren={true}\n                            value=\"no\"\n                        >\n                            Vil ikke!\n                        </RadioBlock>\n                    </>\n                )}\n            </RadioButtonInputGroup>\n        </>\n    );\n};";
const sourceCode$1t = "import { useState } from 'react';\nimport {\n    RadioButtonInputGroup,\n    RadioBlock,\n    RadioSwitch,\n    RadioButton,\n    Tooltip,\n} from '@sb1/ffe-form-react';\nimport { SecondaryButton } from '@sb1/ffe-buttons-react';\n\n() => {\n    const [showErrors, setShowErrors] = useState(false);\n    const [selectedColor, setSelectedColor] = useState('red');\n    const [selectedSmell, setSelectedSmell] = useState();\n\n    return (\n        <>\n            <div className=\"ffe-button-group\">\n                <SecondaryButton onClick={() => setShowErrors(!showErrors)}>\n                    Skru feilmeldinger av/på\n                </SecondaryButton>\n            </div>\n            <RadioButtonInputGroup\n                label=\"Hva er din favorittfarge?\"\n                inline={true}\n                name=\"color\"\n                fieldMessage={showErrors ? 'Feil farge.' : null}\n                tooltip={\n                    <Tooltip>\n                        Din favorittfarge er viktig for oss. Vår er blå!\n                    </Tooltip>\n                }\n                selectedValue={selectedColor}\n                onChange={e => setSelectedColor(e.target.value)}\n            >\n                {inputProps => (\n                    <>\n                        <RadioButton {...inputProps} value=\"red\">\n                            Rød\n                        </RadioButton>\n                        <RadioButton {...inputProps} value=\"blue\">\n                            Blå\n                        </RadioButton>\n                        <RadioButton {...inputProps} value=\"yellow\">\n                            Gul\n                        </RadioButton>\n                        <p>Ekstra innhold</p>\n                    </>\n                )}\n            </RadioButtonInputGroup>\n\n            <RadioButtonInputGroup\n                label=\"Hva er din favorittlukt?\"\n                inline={true}\n                name=\"smell\"\n                fieldMessage={showErrors ? 'Feil lukt.' : null}\n                selectedValue={selectedSmell}\n                onChange={e => setSelectedSmell(e.target.value)}\n            >\n                {inputProps => (\n                    <>\n                        <RadioButton {...inputProps} value=\"grass\">\n                            Gress\n                        </RadioButton>\n                        <RadioButton {...inputProps} value=\"asphalt\">\n                            Asfalt\n                        </RadioButton>\n                        <RadioButton {...inputProps} value=\"pollen\">\n                            Pollen\n                        </RadioButton>\n                    </>\n                )}\n            </RadioButtonInputGroup>\n\n            <RadioButtonInputGroup\n                description=\"Du kan ikke velge begge\"\n                label=\"Velg ja eller nei\"\n                name=\"switch\"\n                fieldMessage={showErrors ? 'Feil valg' : null}\n            >\n                {inputProps => (\n                    <RadioSwitch\n                        leftLabel=\"Ja\"\n                        leftValue={true}\n                        rightLabel=\"Nei\"\n                        rightValue={false}\n                        {...inputProps}\n                    />\n                )}\n            </RadioButtonInputGroup>\n\n            <RadioButtonInputGroup\n                label=\"Velg ja eller nei\"\n                name=\"block1\"\n                selectedValue=\"yes\"\n                fieldMessage={showErrors ? 'Feil valg' : null}\n            >\n                {inputProps => (\n                    <>\n                        <RadioBlock {...inputProps} label=\"Ja\" value=\"yes\" />\n                        <RadioBlock\n                            {...inputProps}\n                            label=\"Nei\"\n                            showChildren={true}\n                            value=\"no\"\n                        >\n                            Vil ikke!\n                        </RadioBlock>\n                    </>\n                )}\n            </RadioButtonInputGroup>\n        </>\n    );\n};\n";
const sourceImports$1t = "import { useState } from 'react';\nimport {\n    RadioButtonInputGroup,\n    RadioBlock,\n    RadioSwitch,\n    RadioButton,\n    Tooltip,\n} from '@sb1/ffe-form-react';\nimport { SecondaryButton } from '@sb1/ffe-buttons-react';";
...
const scope$1q = {useState,Datepicker,Dropdown,InputGroup,Input,TextArea,Checkbox,SecondaryButton};
...
const scope$1p = {formatPercentage};
...
const scope$1o = {formatFodselsnummer};
...
const scope$1m = {formatAccountNumber};
...
const scope$1i = {useState,TabButton,TabButtonGroup,HusIkon,BilIkon,IconCard};
...
const scope$1h = {TabButton,TabButtonGroup};
...
const scope$1g = {useState,Tab,TabGroup,HusIkon,BilIkon,IconCard};
const code$1g = "() => {\n    const displayNone = {\n        display: 'none',\n    };\n\n    const loan = { house: 'house', car: 'car' };\n    const [activeTabId, setActiveTabId] = useState(loan.house);\n\n    return (\n        <>\n            <TabGroup>\n                <Tab\n                    selected={activeTabId === loan.house}\n                    onClick={() => setActiveTabId(loan.house)}\n                    aria-controls={loan.house}\n                >\n                    Huslån\n                </Tab>\n\n                <Tab\n                    selected={activeTabId === loan.car}\n                    onClick={() => setActiveTabId(loan.car)}\n                    aria-controls={loan.car}\n                >\n                    Billån\n                </Tab>\n            </TabGroup>\n\n            <IconCard\n                icon={<HusIkon />}\n                id={loan.house}\n                style={activeTabId === loan.house ? null : displayNone}\n            >\n                {({ Title, Subtext }) => (\n                    <>\n                        <Title>Huslån</Title>\n                        <Subtext>Ta opp huslån</Subtext>\n                    </>\n                )}\n            </IconCard>\n\n            <IconCard\n                icon={<BilIkon />}\n                id={loan.car}\n                style={activeTabId === loan.car ? null : displayNone}\n            >\n                {({ Title, Subtext }) => (\n                    <>\n                        <Title>Billån</Title>\n                        <Subtext>Ta opp billån</Subtext>\n                    </>\n                )}\n            </IconCard>\n        </>\n    );\n};";
...
const scope$1b = {TabButton,TabButtonGroup};
...
const scope$19 = {Tab,Grid,GridRow,GridCol};
...
const scope$16 = {TabButton,Grid,GridRow,GridCol};
...
const scope$13 = {useState,Datepicker};
...
const scope$12 = {useState,Datepicker};
...
const scope$11 = {useState,Datepicker};
...
const scope$$ = {useState,Datepicker};
const code$$ = "() => {\n    const [date, setDate] = useState('01.01.2016');\n\n    return (\n        <Datepicker\n            inputProps={{ id: 'datepicker-example' }}\n            label=\"Velg dato\"\n            language=\"nn\"\n            maxDate=\"31.12.2016\"\n            minDate=\"01.01.2016\"\n            onChange={setDate}\n            value={date}\n        />\n    );\n};";
...
const scope$Z = {useState,Datepicker};
const code$Z = "() => {\n    const [date, setDate] = useState('01.01.2016');\n\n    return (\n        <Datepicker\n            inputProps={{ id: 'datepicker-example' }}\n            label=\"Velg dato\"\n            language=\"en\"\n            maxDate=\"31.12.2016\"\n            minDate=\"01.01.2016\"\n            onChange={setDate}\n            value={date}\n        />\n    );\n};";
...
const scope$X = {useState,Datepicker};
...
const scope$W = {useState,Datepicker,Grid,GridRow,GridCol};
...
const scope$U = {useState,Collapse,ExpandButton};
...
const scope$T = {useState,Collapse,ExpandButton};
...
const scope$S = {Accordion,AccordionItem};
...
const scope$R = {Accordion,AccordionItem};
...
const scope$Q = {useState,Accordion,AccordionItem};
...
const scope$P = {InputGroup,SearchableDropdown,useState};
...
const scope$O = {InputGroup,SearchableDropdown,useState};
...
const scope$M = {Dropdown,InputGroup};
...
const scope$L = {InputGroup,SearchableDropdown,useState};
...
const scope$K = {InputGroup,SearchableDropdown,useState};
...
const scope$J = {InputGroup,SearchableDropdown,useState};
...
const scope$I = {InputGroup,SearchableDropdown,useState};
...
const scope$H = {InputGroup,SearchableDropdown,useState};
...
const scope$G = {InputGroup,SearchableDropdown,useState,SmallText};
...
const scope$E = {IconCard,SparegrisIkon};
...
const scope$A = {IconCard,KryssSirkelIkon};
...
const scope$z = {IconCard,GrafOppIkon};
...
const scope$y = {TertiaryButton,ButtonGroup};
...
const scope$x = {ButtonGroup,PrimaryButton,SecondaryButton};
...
const scope$w = {ButtonGroup,ActionButton,PrimaryButton,SecondaryButton};
...
const scope$v = {SecondaryButton,ButtonGroup,BindersIkon};
...
const scope$u = {useState,ExpandButton};
...
const scope$t = {PrimaryButton,ButtonGroup};
...
const scope$s = {ButtonGroup,ShortcutButton};
...
const scope$r = {TaskButton,ButtonGroup,PlussIkon};
...
const scope$q = {ActionButton,ButtonGroup};
...
const scope$o = {ButtonGroup,PrimaryButton,SecondaryButton,TertiaryButton};
...
const scope$n = {ButtonGroup,PrimaryButton,SecondaryButton,TertiaryButton};
const code$n = "<>\n    <ButtonGroup thin={true}>\n        <SecondaryButton>Forrige</SecondaryButton>\n        <PrimaryButton>Neste</PrimaryButton>\n    </ButtonGroup>\n    <ButtonGroup thin={true}>\n        <TertiaryButton>Avbryt</TertiaryButton>\n    </ButtonGroup>\n</>;";
...
const scope$m = {useState,InlineExpandButton,Collapse,Paragraph};
...
const scope$l = {ContextTipMessage};
...
const scope$k = {ContextTipMessage};
...
const scope$j = {ContextInfoMessage};
...
const scope$i = {ContextTipMessage};
...
const scope$h = {ContextErrorMessage};
...
const scope$g = {ContextInfoMessage};
...
const scope$f = {ContextTipMessage};
...
const scope$e = {ContextSuccessMessage};
...
const scope$d = {ContextErrorMessage};
...
const scope$c = {ContextErrorMessage};
...
const scope$b = {ContextErrorMessage};
...
const scope$a = {ContextInfoMessage};
...
const scope$9 = {ContextErrorMessage};
...
const scope$8 = {ContextSuccessMessage};
...
const scope$7 = {ContextSuccessMessage,HakeIkon};
...
const scope$6 = {ContextInfoMessage};
...
const scope$5 = {ContextErrorMessage,UtropstegnIkon};
...
const scope$4 = {ContextTipMessage,LyspareIkon};
...
const scope$3 = {ContextInfoMessage,InfoIkon};
...
const scope$2 = {ContextSuccessMessage};
...
const scope$1 = {ContextSuccessMessage};
