...
import { InputGroup, Label, RadioBlock, RadioButtonInputGroup, Checkbox, InfoFieldMessage, RadioSwitch, Input, TextArea, PhoneNumber, RadioButton, Tooltip, ErrorFieldMessage, SuccessFieldMessage } from '../../_snowpack/pkg/@sb1/ffe-form-react.js';
import { SmallText, Paragraph, LinkText, PreformattedText, EmphasizedText, StrongText, DividerLine, MicroText, Heading1, Heading2, Heading3, Heading4, Heading5, Heading6 } from '../../_snowpack/pkg/@sb1/ffe-core-react.js';
...
import { DescriptionList, DescriptionListTerm, DescriptionListDescription, NumberedList, NumberedListItem, DescriptionListMultiCol, BulletList, BulletListItem, CheckList, CheckListItem, StylizedNumberedList, StylizedNumberedListItem } from '../../_snowpack/pkg/@sb1/ffe-lists-react.js';
...
import { InfoMessage, ErrorMessage, InfoMessageList, InfoMessageListItem, SuccessMessage, TipsMessage } from '../../_snowpack/pkg/@sb1/ffe-message-box-react.js';
import { HandlevognIkon, PlussIkon, BindersIkon, HusIkon, BilIkon, HakeIkon, KryssIkon, KryssSirkelIkon, SparegrisIkon, GrafOppIkon, SnakkebobleIkon, InfoIkon, LyspareIkon, UtropstegnIkon } from '../../_snowpack/pkg/@sb1/ffe-icons-react.js';
import { TaskButton, ButtonGroup, TertiaryButton, ActionButton, PrimaryButton, SecondaryButton, ShortcutButton, InlineExpandButton, ExpandButton, BackButton } from '../../_snowpack/pkg/@sb1/ffe-buttons-react.js';
...
import { IconCard, TextCard, ImageCard, CardBase } from '../../_snowpack/pkg/@sb1/ffe-cards-react.js';
import ChartDonut from '../../_snowpack/pkg/@sb1/ffe-chart-donut-react.js';
import Table from '../../_snowpack/pkg/@sb1/ffe-tables-react.js';
import { ContextErrorMessage, ContextTipMessage, ContextInfoMessage, ContextSuccessMessage } from '../../_snowpack/pkg/@sb1/ffe-context-message-react.js';
...
const scope$2L = {useState,Datepicker};
...
const scope$2K = {useState,Datepicker};
...
const scope$2I = {useState,Datepicker};
const code$2I = "() => {\n    const [date, setDate] = useState('01.01.2016');\n\n    return (\n        <Datepicker\n            inputProps={{ id: 'datepicker-example' }}\n            label=\"Velg dato\"\n            language=\"nb\"\n            maxDate=\"31.12.2016\"\n            minDate=\"01.01.2016\"\n            onChange={setDate}\n            value={date}\n        />\n    );\n};";
...
const scope$2G = {useState,Datepicker};
...
const scope$2E = {useState,Datepicker};
const code$2E = "() => {\n    const [date, setDate] = useState('01.01.2016');\n\n    return (\n        <Datepicker\n            inputProps={{ id: 'datepicker-example' }}\n            label=\"Velg dato\"\n            language=\"en\"\n            maxDate=\"31.12.2016\"\n            minDate=\"01.01.2016\"\n            onChange={setDate}\n            value={date}\n        />\n    );\n};";
...
const scope$2D = {useState,Datepicker};
...
const scope$2C = {useState,Datepicker,Grid,GridRow,GridCol};
...
const scope$2y = {useState,AccountSelector,InputGroup,SmallText};
...
const scope$2w = {useState,AccountSelector,InputGroup};
...
const scope$2v = {React,formatCurrency};
...
const scope$2u = {formatFodselsnummer};
...
const scope$2t = {React,formatPercentage};
...
const scope$2s = {React,formatNumber};
...
const scope$2r = {formatAccountNumber};
...
const scope$2q = {React,formatDistance};
...
const scope$2p = {React,formatDate};
...
const scope$2o = {Spinner,Paragraph};
...
const scope$2m = {DescriptionList,DescriptionListTerm,DescriptionListDescription};
...
const scope$2l = {NumberedList,NumberedListItem};
...
const scope$2k = {DescriptionList,DescriptionListTerm,DescriptionListDescription};
...
const scope$2j = {DescriptionListMultiCol,DescriptionListTerm,DescriptionListDescription};
...
const scope$2i = {BulletList,BulletListItem};
...
const scope$2h = {CheckList,CheckListItem};
...
const scope$2g = {StylizedNumberedList,StylizedNumberedListItem};
...
const scope$2f = {DescriptionList,DescriptionListTerm,DescriptionListDescription};
const code$2f = "<div>\n    <h3 className=\"ffe-h4\">Personalia</h3>\n    <DescriptionList>\n        <DescriptionListTerm>Navn</DescriptionListTerm>\n        <DescriptionListDescription>Navn Navnesen</DescriptionListDescription>\n        <DescriptionListTerm>Adresse</DescriptionListTerm>\n        <DescriptionListDescription>Husgata 14</DescriptionListDescription>\n        <DescriptionListTerm>Postnummer og sted</DescriptionListTerm>\n        <DescriptionListDescription>1337 Sandvika</DescriptionListDescription>\n    </DescriptionList>\n</div>;";
...
const scope$2e = {CheckList,CheckListItem};
...
const scope$2c = {InputGroup,SearchableDropdown,useState,SmallText};
...
const scope$2b = {InputGroup,SearchableDropdown,useState};
...
const scope$2a = {InputGroup,SearchableDropdown,useState};
...
const scope$29 = {InputGroup,SearchableDropdown,useState};
...
const scope$28 = {InputGroup,SearchableDropdown,useState};
...
const scope$27 = {InputGroup,SearchableDropdown,useState};
...
const scope$26 = {InputGroup,SearchableDropdown,useState};
...
const scope$25 = {InputGroup,SearchableDropdown,useState};
...
const scope$24 = {Dropdown,InputGroup};
...
const scope$23 = {InfoMessage,Paragraph};
...
const scope$22 = {ErrorMessage,Paragraph};
...
const scope$21 = {InfoMessage,InfoMessageList,InfoMessageListItem};
...
const scope$20 = {InfoMessage,Paragraph,HandlevognIkon};
...
const scope$1$ = {SuccessMessage,Paragraph};
...
const scope$1_ = {TipsMessage,Paragraph};
...
const scope$1Z = {ErrorMessage,Paragraph};
...
const scope$1Y = {TaskButton,ButtonGroup,PlussIkon};
...
const scope$1X = {TertiaryButton,ButtonGroup};
...
const scope$1W = {ButtonGroup,ActionButton,PrimaryButton,SecondaryButton};
...
const scope$1V = {ButtonGroup,ShortcutButton};
...
const scope$1U = {ActionButton,ButtonGroup};
...
const scope$1T = {useState,InlineExpandButton,Collapse,Paragraph};
...
const scope$1S = {useState,ExpandButton};
const code$1S = "() => {\n    const [isExpanded, setExpanded] = useState(false);\n\n    return (\n        <div>\n            <ExpandButton\n                isExpanded={isExpanded}\n                onClick={() => setExpanded(!isExpanded)}\n            >\n                Vis mer\n            </ExpandButton>\n        </div>\n    );\n};";
...
const scope$1R = {SecondaryButton,ButtonGroup,BindersIkon};
...
const scope$1P = {PrimaryButton,ButtonGroup};
...
const scope$1O = {ButtonGroup,PrimaryButton,SecondaryButton};
...
const scope$1N = {ButtonGroup,PrimaryButton,SecondaryButton,TertiaryButton};
...
const scope$1M = {ButtonGroup,PrimaryButton,SecondaryButton,TertiaryButton};
const code$1M = "<>\n    <ButtonGroup>\n        <SecondaryButton>Forrige</SecondaryButton>\n        <PrimaryButton>Neste</PrimaryButton>\n    </ButtonGroup>\n    <ButtonGroup>\n        <TertiaryButton>Avbryt</TertiaryButton>\n    </ButtonGroup>\n</>;";
...
const scope$1K = {Accordion,AccordionItem};
...
const scope$1J = {useState,Accordion,AccordionItem};
...
const scope$1I = {Tab,Grid,GridRow,GridCol};
...
const scope$1D = {useState,Tab,TabGroup,HusIkon,BilIkon,IconCard};
...
const scope$1z = {useState,TabButton,TabButtonGroup,HusIkon,BilIkon,IconCard};
const code$1z = "() => {\n    const displayNone = {\n        display: 'none',\n    };\n\n    const loan = { house: 'house', car: 'car' };\n    const [activeTabId, setActiveTabId] = useState(loan.house);\n\n    return (\n        <>\n            <TabButtonGroup>\n                <TabButton\n                    selected={activeTabId === loan.house}\n                    onClick={() => setActiveTabId(loan.house)}\n                    aria-controls={loan.house}\n                >\n                    Huslån\n                </TabButton>\n\n                <TabButton\n                    selected={activeTabId === loan.car}\n                    onClick={() => setActiveTabId(loan.car)}\n                    aria-controls={loan.car}\n                >\n                    Billån\n                </TabButton>\n            </TabButtonGroup>\n\n            <IconCard\n                icon={<HusIkon />}\n                id={loan.house}\n                style={activeTabId === loan.house ? null : displayNone}\n            >\n                {({ Title, Subtext }) => (\n                    <>\n                        <Title>Huslån</Title>\n                        <Subtext>Ta opp huslån</Subtext>\n                    </>\n                )}\n            </IconCard>\n\n            <IconCard\n                icon={<BilIkon />}\n                id={loan.car}\n                style={activeTabId === loan.car ? null : displayNone}\n            >\n                {({ Title, Subtext }) => (\n                    <>\n                        <Title>Billån</Title>\n                        <Subtext>Ta opp billån</Subtext>\n                    </>\n                )}\n            </IconCard>\n        </>\n    );\n};";
...
const scope$1w = {TabButton,Grid,GridRow,GridCol};
...
const scope$1s = {Table,TertiaryButton};
...
const scope$1r = {Table,TertiaryButton,HakeIkon,KryssIkon};
...
const scope$1n = {IconCard,KryssSirkelIkon};
...
const scope$1m = {IconCard,SparegrisIkon};
...
const scope$1i = {IconCard,GrafOppIkon};
...
const scope$1h = {Grid,GridRow,GridCol};
...
const scope$1g = {Grid,GridRow,GridCol};
...
const scope$1f = {useState,Grid,GridRow,GridCol,Dropdown,Label};
...
const scope$1e = {InlineGrid,GridRow,GridCol};
...
const scope$1d = {useState,Grid,GridRow,GridCol,Dropdown,Label};
...
const scope$1c = {InlineGrid,GridRow,GridCol};
...
const scope$1a = {LinkText,SnakkebobleIkon};
...
const scope$19 = {PreformattedText};
...
const scope$15 = {Grid,GridRow,GridCol,DividerLine,Paragraph};
...
const scope$13 = {Heading1,Heading2,Heading3,Heading4,Heading5,Heading6};
...
const scope$11 = {useState,Collapse,ExpandButton};
...
const scope$10 = {useState,Collapse,ExpandButton};
...
const scope$$ = {useState,RadioBlock,RadioButtonInputGroup};
...
const scope$W = {useState,Datepicker,Dropdown,InputGroup,Checkbox,Input,TextArea,SecondaryButton};
...
const scope$T = {useState,RadioSwitch,RadioButtonInputGroup};
...
const scope$R = {InputGroup,Input};
...
const scope$O = {useState,RadioButton,RadioButtonInputGroup};
...
const scope$N = {useState,Tooltip};
...
const scope$L = {useState,RadioButton,RadioButtonInputGroup};
...
const scope$J = {Input,ButtonGroup,PrimaryButton};
...
const scope$H = {useState,RadioSwitch,RadioButtonInputGroup};
const code$H = "() => {\n    const [selected, setSelected] = useState();\n\n    return (\n        <RadioButtonInputGroup\n            label=\"Vil bilen bli kjørt av sjåfører under 23 år?\"\n            tooltip=\"Unge sjåfører har en statistisk høyere sjanse for å bulke bilen.\"\n            name=\"radioButtonInputGroup\"\n            onChange={e => setSelected(e.target.value)}\n            selectedValue={selected}\n        >\n            {inputProps => (\n                <RadioSwitch\n                    leftLabel=\"Ja\"\n                    leftValue=\"true\"\n                    rightLabel=\"Nei\"\n                    rightValue=\"false\"\n                    {...inputProps}\n                />\n            )}\n        </RadioButtonInputGroup>\n    );\n};";
...
const scope$F = {InputGroup,Input,ErrorFieldMessage};
...
const scope$C = {InputGroup,Input,ErrorFieldMessage};
const code$C = "<>\n    <InputGroup\n        label=\"Fornavn\"\n        fieldMessage=\"Jeg er en string-fieldMessage som gir feilmelding\"\n    >\n        <Input\n            name=\"firstname\"\n            onChange={e => console.log('onChange', e.target.value)}\n            onBlur={e => console.log('onBlur', e.target.value)}\n        />\n    </InputGroup>\n\n    <InputGroup\n        label=\"Etternavn\"\n        fieldMessage={\n            <ErrorFieldMessage>\n                Jeg er en ErrorFieldMessage-fieldMessage som gir feilmelding\n            </ErrorFieldMessage>\n        }\n    >\n        <Input\n            name=\"lastname\"\n            onChange={e => console.log('onChange', e.target.value)}\n            onBlur={e => console.log('onBlur', e.target.value)}\n        />\n    </InputGroup>\n\n    <InputGroup\n        label=\"Telefonnummer\"\n        fieldMessage={\n            <div>Jeg er en div-fieldMessage som ikke gir feilmelding</div>\n        }\n    >\n        <Input\n            name=\"phone\"\n            onChange={e => console.log('onChange', e.target.value)}\n            onBlur={e => console.log('onBlur', e.target.value)}\n        />\n    </InputGroup>\n</>;";
...
const scope$B = {TextArea,ButtonGroup,PrimaryButton};
...
const scope$A = {ErrorFieldMessage};
...
const scope$y = {useState,RadioButtonInputGroup,RadioBlock,RadioSwitch,RadioButton,Tooltip,SecondaryButton};
...
const scope$w = {useState,Datepicker,Dropdown,InputGroup,Input,TextArea,Checkbox,SecondaryButton};
...
const scope$u = {useState,RadioButtonInputGroup,RadioBlock,RadioSwitch,RadioButton,Tooltip,SecondaryButton};
const code$u = "() => {\n    const [showErrors, setShowErrors] = useState(false);\n    const [selectedColor, setSelectedColor] = useState('red');\n    const [selectedSmell, setSelectedSmell] = useState();\n\n    return (\n        <>\n            <div className=\"ffe-button-group\">\n                <SecondaryButton onClick={() => setShowErrors(!showErrors)}>\n                    Skru feilmeldinger av/på\n                </SecondaryButton>\n            </div>\n            <RadioButtonInputGroup\n                extraMargin={false}\n                label=\"Hva er din favorittfarge?\"\n                inline={true}\n                name=\"color\"\n                fieldMessage={showErrors ? 'Feil farge.' : null}\n                tooltip={\n                    <Tooltip>\n                        Din favorittfarge er viktig for oss. Vår er blå!\n                    </Tooltip>\n                }\n                selectedValue={selectedColor}\n                onChange={e => setSelectedColor(e.target.value)}\n            >\n                {inputProps => (\n                    <>\n                        <RadioButton {...inputProps} value=\"red\">\n                            Rød\n                        </RadioButton>\n                        <RadioButton {...inputProps} value=\"blue\">\n                            Blå\n                        </RadioButton>\n                        <RadioButton {...inputProps} value=\"yellow\">\n                            Gul\n                        </RadioButton>\n                        <p>Ekstra innhold</p>\n                    </>\n                )}\n            </RadioButtonInputGroup>\n\n            <RadioButtonInputGroup\n                extraMargin={false}\n                label=\"Hva er din favorittlukt?\"\n                inline={true}\n                name=\"smell\"\n                fieldMessage={showErrors ? 'Feil lukt.' : null}\n                selectedValue={selectedSmell}\n                onChange={e => setSelectedSmell(e.target.value)}\n            >\n                {inputProps => (\n                    <>\n                        <RadioButton {...inputProps} value=\"grass\">\n                            Gress\n                        </RadioButton>\n                        <RadioButton {...inputProps} value=\"asphalt\">\n                            Asfalt\n                        </RadioButton>\n                        <RadioButton {...inputProps} value=\"pollen\">\n                            Pollen\n                        </RadioButton>\n                    </>\n                )}\n            </RadioButtonInputGroup>\n\n            <RadioButtonInputGroup\n                extraMargin={false}\n                description=\"Du kan ikke velge begge\"\n                label=\"Velg ja eller nei\"\n                name=\"switch\"\n                fieldMessage={showErrors ? 'Feil valg' : null}\n            >\n                {inputProps => (\n                    <RadioSwitch\n                        leftLabel=\"Ja\"\n                        leftValue={true}\n                        rightLabel=\"Nei\"\n                        rightValue={false}\n                        {...inputProps}\n                    />\n                )}\n            </RadioButtonInputGroup>\n\n            <RadioButtonInputGroup\n                extraMargin={false}\n                label=\"Velg ja eller nei\"\n                name=\"block1\"\n                selectedValue=\"yes\"\n                fieldMessage={showErrors ? 'Feil valg' : null}\n            >\n                {inputProps => (\n                    <>\n                        <RadioBlock {...inputProps} label=\"Ja\" value=\"yes\" />\n                        <RadioBlock\n                            {...inputProps}\n                            label=\"Nei\"\n                            showChildren={true}\n                            value=\"no\"\n                        >\n                            Vil ikke!\n                        </RadioBlock>\n                    </>\n                )}\n            </RadioButtonInputGroup>\n        </>\n    );\n};";
...
const scope$s = {SuccessFieldMessage};
...
const scope$r = {ContextErrorMessage};
...
const scope$q = {ContextTipMessage};
...
const scope$p = {ContextInfoMessage};
...
const scope$o = {ContextSuccessMessage};
...
const scope$n = {ContextSuccessMessage};
...
const scope$m = {ContextInfoMessage};
...
const scope$k = {ContextInfoMessage,InfoIkon};
...
const scope$j = {ContextErrorMessage};
...
const scope$h = {ContextInfoMessage};
...
const scope$g = {ContextTipMessage,LyspareIkon};
...
const scope$f = {ContextErrorMessage};
...
const scope$e = {ContextErrorMessage};
...
const scope$d = {ContextSuccessMessage,HakeIkon};
...
const scope$c = {ContextTipMessage};
...
const scope$b = {ContextSuccessMessage};
...
const scope$a = {ContextErrorMessage};
...
const scope$9 = {ContextErrorMessage,UtropstegnIkon};
...
const scope$8 = {ContextInfoMessage};
...
const scope$7 = {ContextSuccessMessage};
...
const scope$6 = {DetailList,Detail,DetailContent,TertiaryButton};
...
const scope$5 = {SystemErrorMessage};
...
const scope$2 = {SystemSuccessMessage};
...
const scope$1 = {SystemInfoMessage};
