...
export const HighFive: React.FC = () => {
    return (
        <svg
            width="180"
            viewBox="0 0 331 320"
        ...
        >
            <g clipPath="url(#a)">
                <circle cx="165" cy="160" r="160" fill="#005AA4" />
                <g clipPath="url(#b)">
                    <mask
                        id="c"
            ...
            <defs>
                <clipPath id="a">
                    <path fill="#fff" d="M0 0h331v320H0z" />
                </clipPath>
                <clipPath id="b">
                    <path fill="#fff" d="M0 0h330.9v496.7H0z" />
                </clipPath>
            </defs>
        </svg>
    );
