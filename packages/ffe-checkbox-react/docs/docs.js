...
const example = (
    <div>
        <div className="component-intro">
            ...
            <p
                className="ffe-micro-text"
                style={{ position: 'relative', bottom: '22px' }}
            >
                HENTET FRA{' '}
                <a href="https://stash.intern.sparebank1.no/projects/FFE/repos/ffe-checkbox-react">
                    STASH
                </a>
            </p>
            <p>
                Brukes når det er flere mulige valg. Har en standard og en
                inline variant.
            </p>
        </div>
        ...
        <div className="expanding-field">
            ...
            <span className="expanding-field__icon" />
        ...
        <div className="expanding-field">
            <button className="expanding-field__toggle">
                Vis API for React-komponent
            </button>
            <span className="expanding-field__icon" />
            <div className="expanding-field__content">
                <pre>
                    <code className="html hljs js">{`<Checkbox
onChange={ () => {} }
checked={false}
