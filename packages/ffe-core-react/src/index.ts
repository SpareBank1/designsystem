...
export type { DividerLineProps } from './typography/DividerLine';
export { EmphasizedText } from './typography/EmphasizedText';
export type { EmphasizedTextProps } from './typography/EmphasizedText';
export {
    Heading1,
    Heading2,
    Heading3,
...
export type { LinkTextProp } from './typography/LinkText';
export { LinkIcon } from './typography/LinkIcon';
export type { LinkIconProp } from './typography/LinkIcon';
export { MicroText } from './typography/MicroText';
export type { MicroTextProps } from './typography/MicroText';
...
export type { PreformattedTextProps } from './typography/PreformattedText';
export { SmallText } from './typography/SmallText';
export type { SmallTextProps } from './typography/SmallText';
