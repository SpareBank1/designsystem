...
function ButtonsExample() {
    return (
        <div>
            ...
            <div className="ffe-content-container">
                <PrimaryButton condensed>
                    Condensed primary button
                </PrimaryButton>
            </div>
            <div className="ffe-content-container">
            ...
            <div className="ffe-content-container">
                <SecondaryButton leftIcon={<FaksPrinterSolidIkon />}>
                    I'm a secondary button with icon
                </SecondaryButton>
            </div>
            <div className="ffe-content-container">
                <SecondaryButton condensed>
                    Condensed secondary button
                </SecondaryButton>
            </div>
            <div className="ffe-content-container">
            ...
            <div className="ffe-content-container">
                <ShortcutButton condensed>
                    Condensed shortcut button
                </ShortcutButton>
            </div>
            <div className="ffe-content-container">
                <TertiaryButton leftIcon={<FaksPrinterSolidIkon />}>
                    I'm a tertiary button with icon
                </TertiaryButton>
            </div>
            <div className="ffe-content-container">
            ...
            <div className="ffe-content-container">
                <TertiaryButton condensed>
                    Condensed tertiary button
                </TertiaryButton>
            </div>
            <div className="ffe-content-container">
