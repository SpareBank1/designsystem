...
const checkValidMdColumns = modifier => {
    const total = typeof modifier === 'object' ? modifier.cols + modifier.offset : modifier;

    if (!(total % 2 === 0 && (modifier.cols || 0) % 2 === 0 && (modifier.offset || 0) % 2 === 0)) {
        console.error(`
...
const checkValidSmColumns = modifier => {
    ...
    if (!(total % 3 === 0 && (modifier.cols || 0) % 3 === 0 && (modifier.offset || 0) % 3 === 0)) {
        console.error(`
