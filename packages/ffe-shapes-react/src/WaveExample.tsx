...
export const WaveExample: React.FC = () => {
    return (
        <>
            <Grid>
                <GridRow padding="sm">
                    ...
                    >
                        <Heading1>
                            Hei, velkommen til din pensjonsoversikt
                        </Heading1>

                        <Paragraph lead={true}>
                            Her finner du oversikt over din pensjon i SpareBank
                            1
                        </Paragraph>
                    </GridCol>
                </GridRow>
                    ...
                    <GridCol sm={5}>
                        <div>
                            ...
                            <p className="ffe-body-paragraph">
                                Andre på din alder velger ofte
                                pensjonssparekonto. Du har også mulighet til å
                                velge pensjonssparing med skattefordel (IPS).
                            </p>
                            <div className="ffe-button-group">
                                <PrimaryButton>Velg din sparing</PrimaryButton>
                            </div>
                            <p className="ffe-body-paragraph ffe-small-text">
                                * Du får lavere pris på din forvaltning. Dette
                                får du fordi du enten er ansatt i en bedrift som
                                har pensjonssparing hos oss, har valgt å ha egen
                                pensjonskonto hos oss, eller fordi du har et
                                pensjonskapitalbevis eller pensjonsbevis hos
                                oss.
                            </p>
                        </div>
                    </GridCol>
