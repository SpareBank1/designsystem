...
describe('simpleDate fromString', () => {
    ...
    describe('formats', () => {
        it('single digit dates as double digit values', () =>
            assert.deepEqual(
                simpleDate.fromString('01.01.2016').format(),
                '01.01.2016',
            ));

        it('double digit dates as double digit values', () =>
            assert.deepEqual(
                simpleDate.fromString('10.10.2016').format(),
                '10.10.2016',
            ));
    });
    ...
    describe('accepts', () => {
        it('single digit day', () =>
            assert.deepEqual(
                simpleDate.fromString('5.04.2015').format(),
                '05.04.2015',
            ));

        it('single digit month', () =>
            assert.deepEqual(
                simpleDate.fromString('25.1.2015').format(),
                '25.01.2015',
            ));

        it('double digit year', () =>
            assert.deepEqual(
                simpleDate.fromString('10.10.17').format(),
                '10.10.2017',
            ));

        it('no separators for 4 digit years', () =>
            assert.deepEqual(
                simpleDate.fromString('10102016').format(),
                '10.10.2016',
            ));

        it('no separators for 2 digit years', () =>
            assert.deepEqual(
                simpleDate.fromString('101016').format(),
                '10.10.2016',
            ));
    ...
    describe('during last day of month', () => {
        ...
        describe('given date from month with 30 days', () => {
            ...
            it('formats', () =>
                assert.deepEqual(
                    simpleDate.fromString('01.09.2017').format(),
                    '01.09.2017',
                ));
        });
        ...
        describe('given date from month with 28 days', () => {
            ...
            it('formats', () =>
                assert.deepEqual(
                    simpleDate.fromString('05.02.2015').format(),
                    '05.02.2015',
                ));
        });
    });
